...
!function webpackUniversalModuleDefinition(t, r) {
    ...
    return function(t) {
        ...
        function __w_pdfjs_require__(a) {
            ...
            return t[a].call(o.exports, o, o.exports, __w_pdfjs_require__),
            o.l = !0,
            o.exports
        }
        return __w_pdfjs_require__.m = t,
        ...
        __w_pdfjs_require__.t = function(t, r) {
            if (1 & r && (t = __w_pdfjs_require__(t)),
            8 & r)
                return t;
            if (4 & r && "object" == typeof t && t && t.__esModule)
                return t;
            var a = Object.create(null);
            if (__w_pdfjs_require__.r(a),
            ...
            2 & r && "string" != typeof t)
                for (var o in t)
                    __w_pdfjs_require__.d(a, o, function(r) {
                        return t[r]
                    }
                    .bind(null, o));
            return a
        ...
        __w_pdfjs_require__.n = function(t) {
            ...
            ;
            return __w_pdfjs_require__.d(r, "a", r),
            r
        }
        ,
        ...
        if (a(7).isNodeJS) {
            ...
            (0,
            i.setPDFNetworkStreamFactory)((function(t) {
                return new m(t)
            }
            ))
        } else {
            ...
            (0,
            o.isFetchSupported)() && (v = a(216).PDFFetchStream),
            (0,
            i.setPDFNetworkStreamFactory)((function(t) {
                return v && (0,
                o.isValidFetchUrl)(t.url) ? new v(t) : new g(t)
            }
            ))
        }
    }
    , function(t, r, a) {
        ...
        r.addLinkAttributes = function addLinkAttributes(t) {
            var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}
              ...
              , d = void 0 === c || c;
            (0,
            i.assert)(a && "string" == typeof a, 'addLinkAttributes: A valid "url" parameter must provided.');
            var h = (0,
            i.removeNullCharacters)(a);
            d ? t.href = t.title = h : (t.href = "",
        ...
        function _createClass(t, r, a) {
            return r && _defineProperties(t.prototype, r),
                    ...
                    var t = _asyncToGenerator(o.default.mark((function _callee2(t) {
                        ...
                        return o.default.wrap((function _callee2$(c) {
                            for (; ; )
                                ...
                                case 5:
                                    if (a = this.baseUrl + r + (this.isCompressed ? ".bcmap" : ""),
                                    l = this.isCompressed ? i.CMapCompressionType.BINARY : i.CMapCompressionType.NONE,
                                    !isFetchSupported() || !isValidFetchUrl(a, document.baseURI)) {
                                        c.next = 9;
                                        break
                                    }
                                ...
                                case 9:
                                    return c.abrupt("return", new Promise((function(t, r) {
                                        ...
                                        o.open("GET", a, !0),
                                        u.isCompressed && (o.responseType = "arraybuffer"),
                                        o.onreadystatechange = function() {
                                            if (o.readyState === XMLHttpRequest.DONE) {
                                                var a;
                                                if (200 === o.status || 0 === o.status)
                                                    if (u.isCompressed && o.response ? a = new Uint8Array(o.response) : !u.isCompressed && o.responseText && (a = (0,
                                                    i.stringToBytes)(o.responseText)),
                                                    a)
                                                        return void t({
                                                            cMapData: a,
                                                            compressionType: l
        ...
        var h = function() {
            ...
            return _createClass(DOMSVGFactory, [{
                ...
                value: function create(t, r) {
                    (0,
                    i.assert)(t > 0 && r > 0, "Invalid SVG dimensions");
                    var a = document.createElementNS(u, "svg:svg");
                    return a.setAttribute("version", "1.1"),
                ...
                value: function createElement(t) {
                    return (0,
                    i.assert)("string" == typeof t, "Invalid SVG element type"),
        ...
        var p = function() {
            function PageViewport(t) {
                ...
                this.offsetX = l,
                this.offsetY = c;
                var p, m, v, g, y, b, _, S, A = (r[2] + r[0]) / 2, C = (r[3] + r[1]) / 2;
                ...
                h && (v = -v,
                g = -g),
                0 === p ? (y = Math.abs(C - r[1]) * a + l,
                b = Math.abs(A - r[0]) * a + c,
                _ = Math.abs(r[3] - r[1]) * a,
                S = Math.abs(r[2] - r[0]) * a) : (y = Math.abs(A - r[0]) * a + l,
                b = Math.abs(C - r[1]) * a + c,
                _ = Math.abs(r[2] - r[0]) * a,
                S = Math.abs(r[3] - r[1]) * a),
                this.transform = [p * a, m * a, v * a, g * a, y - p * a * A - v * a * C, b - m * a * A - g * a * C],
                this.width = _,
                this.height = S
            }
        ...
        var m = function(t) {
            ...
            function RenderingCancelledException(t, a) {
                var o;
                return _classCallCheck(this, RenderingCancelledException),
                (o = r.call(this, t)).type = a,
                o
            }
        ...
        var g, y = function() {
            ...
            return _createClass(StatTimer, [{
                ...
                value: function time(t) {
                    t in this.started && (0,
                    i.warn)("Timer is already running for ".concat(t)),
                ...
                value: function timeEnd(t) {
                    t in this.started || (0,
                    i.warn)("Timer has not been started for ".concat(t)),
                    this.times.push({
                        name: t,
                ...
                value: function toString() {
                    var t, r = [], a = 0, o = _createForOfIteratorHelper(this.times);
                    try {
                        for (o.s(); !(t = o.n()).done; ) {
                            var i = t.value.name;
    ...
    , function(t, r, a) {
        ...
        (function(t) {
            ...
            var r = function(t) {
                var r, a = Object.prototype, o = a.hasOwnProperty, i = "function" == typeof Symbol ? Symbol : {}, l = i.iterator || "@@iterator", u = i.asyncIterator || "@@asyncIterator", c = i.toStringTag || "@@toStringTag";
                ...
                function maybeInvokeDelegate(t, a) {
                    ...
                    if (o === r) {
                        if (a.delegate = null,
                        "throw" === a.method) {
                            if (t.iterator.return && (a.method = "return",
                            a.arg = r,
                    ...
                    if ("throw" === i.type)
                        ...
                        v;
                    var l = i.arg;
                    return l ? l.done ? (a[t.resultName] = l.value,
                    a.next = t.nextLoc,
                ...
                return GeneratorFunction.prototype = _.constructor = GeneratorFunctionPrototype,
    ...
    , function(t, r, a) {
        ...
        r.arraysToBytes = function arraysToBytes(t) {
            var r = t.length;
            if (1 === r && t[0]instanceof Uint8Array)
                return t[0];
            for (var a = 0, o = 0; o < r; o++)
                a += arrayByteLength(t[o]);
        ...
        r.isSameOrigin = function isSameOrigin(t, r) {
            var a;
            try {
                if (!(a = new URL(t)).origin || "null" === a.origin)
                    return !1
            } catch (t) {
                return !1
            }
        ...
        r.removeNullCharacters = function removeNullCharacters(t) {
            if ("string" != typeof t)
                return warn("The argument for removeNullCharacters must be a string."),
                t;
            return t.replace(g, "")
        }
        ,
        ...
        r.IsEvalSupportedCached = r.IsLittleEndianCached = r.createObjectURL = r.FormatError = r.Util = r.UnknownErrorException = r.UnexpectedResponseException = r.TextRenderingMode = r.StreamType = r.PermissionFlag = r.PasswordResponses = r.PasswordException = r.MissingPDFException = r.InvalidPDFException = r.AbortException = r.CMapCompressionType = r.ImageKind = r.FontType = r.AnnotationType = r.AnnotationStateModelType = r.AnnotationReviewState = r.AnnotationReplyType = r.AnnotationMarkedState = r.AnnotationFlag = r.AnnotationFieldFlag = r.AnnotationBorderStyleType = r.UNSUPPORTED_FEATURES = r.VerbosityLevel = r.OPS = r.IDENTITY_MATRIX = r.FONT_IDENTITY_MATRIX = r.BaseException = void 0,
        a(6);
        ...
        var u = function(t) {
            ...
            function PasswordException(t, a) {
                var o;
                return _classCallCheck(this, PasswordException),
                (o = r.call(this, t)).code = a,
                o
            }
        ...
        var c = function(t) {
            ...
            function UnknownErrorException(t, a) {
                var o;
                return _classCallCheck(this, UnknownErrorException),
                (o = r.call(this, t)).details = a,
                o
            }
        ...
        var d = function(t) {
            ...
            function InvalidPDFException() {
                return _classCallCheck(this, InvalidPDFException),
        ...
        var h = function(t) {
            ...
            function MissingPDFException() {
                return _classCallCheck(this, MissingPDFException),
                r.apply(this, arguments)
            }
        ...
        var p = function(t) {
            ...
            function UnexpectedResponseException(t, a) {
                var o;
                return _classCallCheck(this, UnexpectedResponseException),
                (o = r.call(this, t)).status = a,
                o
            }
        ...
        var m = function(t) {
            ...
            function FormatError() {
                return _classCallCheck(this, FormatError),
                r.apply(this, arguments)
            }
            return FormatError
        }(l);
        ...
        var v = function(t) {
            ...
            function AbortException() {
                return _classCallCheck(this, AbortException),
                r.apply(this, arguments)
            }
        ...
        function stringToBytes(t) {
            ...
            for (var r = t.length, a = new Uint8Array(r), o = 0; o < r; ++o)
                a[o] = 255 & t.charCodeAt(o);
            return a
        }
        function arrayByteLength(t) {
            return void 0 !== t.length ? t.length : (assert(void 0 !== t.byteLength, "arrayByteLength - invalid argument."),
            t.byteLength)
        }
        var y = {
            get value() {
            ...
            return function _createClass(t, r, a) {
                ...
                value: function intersect(t, r) {
                    ...
                    var a = [t[0], t[2], r[0], r[2]].sort(compare)
                      ...
                      , i = [];
                    return t = Util.normalizeRect(t),
                    r = Util.normalizeRect(r),
                    a[0] === t[0] && a[1] === r[0] || a[0] === r[0] && a[1] === t[0] ? (i[0] = a[1],
                    i[2] = a[2],
                    o[0] === t[1] && o[1] === r[1] || o[0] === r[1] && o[1] === t[1] ? (i[1] = o[1],
                    i[3] = o[2],
                    i) : null) : null
                }
            }]),
        ...
        if ("undefined" == typeof globalThis || !globalThis._pdfjsCompatibilityChecked) {
            ...
            function checkDOMTokenListAddRemove() {
                if (i && !o.isNodeJS) {
                    ...
                    if (t.classList.add("testOne", "testTwo"),
    ...
    , function(t, r, a) {
        ...
        t.exports = function(t, r) {
            var a, p, m, v, g, y = t.target, b = t.global, _ = t.stat;
    ...
    , function(t, r, a) {
        ...
        t.exports = function(t, r) {
            if (!o(t))
                return t;
            var a, i;
            if (r && "function" == typeof (a = t.toString) && !o(i = a.call(t)))
                return i;
            if ("function" == typeof (a = t.valueOf) && !o(i = a.call(t)))
                return i;
            if (!r && "function" == typeof (a = t.toString) && !o(i = a.call(t)))
                return i;
    ...
    , function(t, r, a) {
        ...
        (t.exports = function(t, r, a, c) {
            var d = !!c && !!c.unsafe
              , h = !!c && !!c.enumerable
              , v = !!c && !!c.noTargetGet;
            "function" == typeof a && ("string" != typeof r || l(a, "name") || i(a, "name", r),
            p(a).source = m.join("string" == typeof r ? r : "")),
            t !== o ? (d ? !v && t[r] && (h = !0) : delete t[r],
            h ? t[r] = a : i(t, r, a)) : h ? t[r] = a : u(r, a)
        }
    ...
    , function(t, r, a) {
        var o, i, l, u = a(34), c = a(11), d = a(22), h = a(26), p = a(23), m = a(35), v = a(39), g = c.WeakMap;
        if (u) {
            var y = new g
              , b = y.get
              , _ = y.has
    ...
    , function(t, r, a) {
        ...
        t.exports = function(t, r) {
            var a, c = i(t), d = 0, h = [];
            for (a in c)
                !o(u, a) && o(c, a) && h.push(a);
            for (; r.length > d; )
                o(c, a = r[d++]) && (~l(h, a) || h.push(a));
            return h
        }
    }
    , function(t, r, a) {
        var o = a(17)
          ...
          , createMethod = function(t) {
            return function(r, a, u) {
                var c, d = o(r), h = i(d.length), p = l(u, h);
                if (t && a != a) {
                    for (; h > p; )
                        if ((c = d[p++]) != c)
                            return !0
    ...
    , function(t, r, a) {
        "use strict";
        var o, i = a(10), l = a(12).f, u = a(47), c = a(55), d = a(20), h = a(60), p = a(37), m = "".startsWith, v = Math.min, g = h("startsWith");
        i({
            target: "String",
            proto: !0,
            forced: !!(p || g || (o = l(String.prototype, "startsWith"),
            !o || o.writable)) && !g
        }, {
    ...
    , function(t, r, a) {
        ...
        t.exports = function(t) {
            return l(h, t) || (c && l(p, t) ? h[t] = p[t] : h[t] = m("Symbol." + t)),
            h[t]
        }
    }
    , function(t, r, a) {
    ...
    , function(t, r, a) {
        "use strict";
        var o, i = a(10), l = a(12).f, u = a(47), c = a(55), d = a(20), h = a(60), p = a(37), m = "".endsWith, v = Math.min, g = h("endsWith");
        i({
            target: "String",
            proto: !0,
            forced: !!(p || g || (o = l(String.prototype, "endsWith"),
            !o || o.writable)) && !g
        }, {
    ...
    , function(t, r, a) {
        var o, i = a(28), l = a(72), u = a(50), c = a(39), d = a(74), h = a(25), p = a(35), m = p("IE_PROTO"), EmptyConstructor = function() {}, scriptTag = function(t) {
            ...
            NullProtoObject = o ? function(t) {
                ...
                return t = null,
                r
            }(o) : ((r = h("iframe")).style.display = "none",
            d.appendChild(r),
        ...
        t.exports = Object.create || function create(t, r) {
            var a;
            return null !== t ? (EmptyConstructor.prototype = i(t),
            a = new EmptyConstructor,
            EmptyConstructor.prototype = null,
            a[m] = t) : a = NullProtoObject(),
            void 0 === r ? a : l(a, r)
        }
    }
    , function(t, r, a) {
        ...
        t.exports = o ? Object.defineProperties : function defineProperties(t, r) {
            l(t);
            for (var a, o = u(r), c = o.length, d = 0; c > d; )
                i.f(t, a = o[d++], r[a]);
            return t
        }
    }
    ...
    , function(t, r, a) {
        ...
        l(String, "String", (function(t) {
            ...
            var t, r = d(this), a = r.string, i = r.index;
            return i >= a.length ? {
                value: void 0,
                done: !0
            } : (t = o(a, i),
    ...
    , function(t, r, a) {
        var o = a(48)
          ...
          , createMethod = function(t) {
            return function(r, a) {
                var l, u, c = String(i(r)), d = o(a), h = c.length;
    ...
    , function(t, r, a) {
        ...
        t.exports = function(t, r, a, p, g, R, k) {
            ...
            }, T = r + " Iterator", E = !1, O = t.prototype, I = O[_] || O["@@iterator"] || g && O[g], D = !b && I || getIterationMethod(g), L = "Array" == r && O.entries || I;
            if (L && (P = l(L.call(new t)),
            y !== Object.prototype && P.next && (m || l(P) === y || (u ? u(P, y) : "function" != typeof P[_] && d(P, _, returnThis)),
            c(P, T, !0, !0),
            m && (v[T] = returnThis))),
            g == A && I && I.name !== A && (E = !0,
            D = function values() {
    ...
    , function(t, r, a) {
        "use strict";
        var o, i, l, u = a(82), c = a(26), d = a(23), h = a(57), p = a(37), m = h("iterator"), v = !1;
        [].keys && ("next"in (l = [].keys()) ? (i = u(u(l))) !== Object.prototype && (o = i) : v = !0),
        null == o && (o = {}),
        p || d(o, m) || c(o, m, (function() {
            return this
        }
        )),
        t.exports = {
    ...
    , function(t, r, a) {
        ...
        t.exports = u ? Object.getPrototypeOf : function(t) {
            return t = i(t),
            o(t, c) ? t[c] : "function" == typeof t.constructor && t instanceof t.constructor ? t.constructor.prototype : t instanceof Object ? d : null
        }
    }
    , function(t, r, a) {
        var o = a(20);
    ...
    , function(t, r, a) {
        ...
        t.exports = function from(t) {
            var r, a, p, m, v, g, y = i(t), b = "function" == typeof this ? this : Array, _ = arguments.length, S = _ > 1 ? arguments[1] : void 0, A = void 0 !== S, C = h(y), R = 0;
            if (A && (S = o(S, _ > 2 ? arguments[2] : void 0, 2)),
            null == C || b == Array && u(C))
                for (a = new b(r = c(y.length)); r > R; R++)
                    g = A ? S(y[R], R) : y[R],
                    d(a, R, g);
            else
                for (v = (m = C.call(y)).next,
                a = new b; !(p = v.call(m)).done; R++)
                    g = A ? l(m, S, [p.value, R], !0) : p.value,
                    d(a, R, g);
            return a.length = R,
            a
        }
    ...
    , function(t, r, a) {
        ...
        t.exports = !p || i((function() {
            ...
            for (var a = d(t), i = arguments.length, p = 1, m = u.f, v = c.f; i > p; )
                for (var g, y = h(arguments[p++]), b = m ? l(y).concat(m(y)) : l(y), _ = b.length, S = 0; _ > S; )
                    g = b[S++],
                    o && !v.call(y, g) || (a[g] = y[g]);
            return a
        }
        : p
    }
    ...
    , function(t, r, a) {
        ...
        d("slice", (function slice(t, r) {
            for (var a = h.call(u(this), t, r), o = i(this, this.constructor), l = 0, d = a.length, p = new (c(o))(d); d > l; )
                p[l] = a[l++];
            return p
        }
        ), l((function() {
    ...
    , function(t, r, a) {
        "use strict";
        var o, i = a(111), l = a(13), u = a(11), c = a(22), d = a(23), h = a(95), p = a(26), m = a(29), v = a(27).f, g = a(82), y = a(87), b = a(57), _ = a(38), S = u.Int8Array, A = S && S.prototype, C = u.Uint8ClampedArray, R = C && C.prototype, k = S && g(S), P = A && g(A), w = Object.prototype, x = w.isPrototypeOf, T = b("toStringTag"), E = _("TYPED_ARRAY_TAG"), O = i && !!y && "Opera" !== h(u.opera), I = !1, D = {
            Int8Array: 1,
            Uint8Array: 1,
            Uint8ClampedArray: 1,
            Int16Array: 2,
        ...
        O))
            for (o in D)
                u[o] && y(u[o], k);
        if ((!O || !P || P === w) && (P = k.prototype,
        O))
            for (o in D)
                u[o] && y(u[o].prototype, P);
        if (O && g(R) !== P && y(R, P),
        l && !d(P, T))
            for (o in I = !0,
            v(P, T, {
    ...
    , function(t, r, a) {
        ...
        var o, i, l, u, c = a(10), d = a(37), h = a(11), p = a(42), m = a(120), v = a(29), g = a(121), y = a(85), b = a(122), _ = a(22), S = a(63), A = a(123), C = a(19), R = a(31), k = a(124), P = a(97), w = a(112), x = a(125).set, T = a(128), E = a(129), O = a(131), I = a(130), D = a(132), L = a(33), W = a(52), M = a(57), j = a(133), N = M("species"), B = "Promise", q = L.get, G = L.set, U = L.getterFor(B), z = m, H = h.TypeError, Y = h.document, X = h.process, V = p("fetch"), Q = I.f, K = Q, J = "process" == C(X), $ = !!(Y && Y.createEvent && h.dispatchEvent), Z = "unhandledrejection", ee = W(B, (function() {
            ...
            return (t.constructor = {})[N] = FakePromise,
            !(t.then((function() {}
            ...
            if (!r.notified) {
                ...
                T((function() {
                    for (var i = r.value, l = 1 == r.state, u = 0; o.length > u; ) {
                        var c, d, h, p = o[u++], m = l ? p.ok : p.fail, v = p.resolve, g = p.reject, y = p.domain;
                        try {
                            m ? (l || (2 === r.rejection && onHandleUnhandled(t, r),
                            r.rejection = 1),
                            !0 === m ? c = i : (y && y.enter(),
                            c = m(i),
                            y && (y.exit(),
                            h = !0)),
                            c === p.promise ? g(H("Promise-chain cycle")) : (d = isThenable(c)) ? d.call(c, v, g) : v(c)) : g(i)
                        } catch (t) {
                            y && !h && y.exit(),
                            g(t)
                        }
        ...
        ,
        d || "function" != typeof m || (u = m.prototype.then,
        v(m.prototype, "then", (function then(t, r) {
            var a = this;
        ...
        (t.exports = function(t, r, a, h, p) {
            ...
            if (p)
                ...
                if (i(v)) {
                    for (g = 0,
                    y = l(t.length); y > g; g++)
                        if ((b = h ? A(o(S = t[g])[0], S[1]) : A(t[g])) && b instanceof Result)
                            return b;
                    return new Result(!1)
                }
                m = v.call(t)
            ...
            for (_ = m.next; !(S = _.call(m)).done; )
                if ("object" == typeof (b = d(m, A, S.value, h)) && b && b instanceof Result)
                    return b;
            return new Result(!1)
        }
        ).stop = function(t) {
    ...
    , function(t, r, a) {
        var o, i, l, u = a(11), c = a(14), d = a(19), h = a(62), p = a(74), m = a(25), v = a(126), g = u.location, y = u.setImmediate, b = u.clearImmediate, _ = u.process, S = u.MessageChannel, A = u.Dispatch, C = 0, R = {}, k = "onreadystatechange", run = function(t) {
        ...
        y && b || (y = function setImmediate(t) {
            for (var r = [], a = 1; arguments.length > a; )
                r.push(arguments[a++]);
            return R[++C] = function() {
        ...
        o = h(l.postMessage, l, 1)) : !u.addEventListener || "function" != typeof postMessage || u.importScripts || c(post) || "file:" === g.protocol ? o = k in m("script") ? function(t) {
    ...
    , function(t, r, a) {
        var o, i, l, u, c, d, h, p, m = a(11), v = a(12).f, g = a(19), y = a(125).set, b = a(126), _ = m.MutationObserver || m.WebKitMutationObserver, S = m.process, A = m.Promise, C = "process" == g(S), R = v(m, "queueMicrotask"), k = R && R.value;
        k || (o = function() {
            var t, r;
        ...
        ) : A && A.resolve ? (h = A.resolve(void 0),
        p = h.then,
        u = function() {
            p.call(h, o)
        }
    ...
    , function(t, r, a) {
        var o, i, l = a(11), u = a(127), c = l.process, d = c && c.versions, h = d && d.v8;
        h ? i = (o = h.split("."))[0] + o[1] : u && (!(o = u.match(/Edge\/(\d+)/)) || o[1] >= 74) && (o = u.match(/Chrome\/(\d+)/)) && (i = o[1]),
        t.exports = i && +i
    }
    , function(t, r, a) {
        "use strict";
    ...
    , function(t, r, a) {
        ...
        var o, i = a(10), l = a(13), u = a(138), c = a(11), d = a(72), h = a(29), p = a(123), m = a(23), v = a(100), g = a(90), y = a(78).codeAt, b = a(139), _ = a(85), S = a(140), A = a(33), C = c.URL, R = S.URLSearchParams, k = S.getState, P = A.set, w = A.getterFor("URL"), x = Math.floor, T = Math.pow, E = "Invalid scheme", O = "Invalid host", I = "Invalid port", D = /[A-Za-z]/, L = /[\d+-.A-Za-z]/, W = /\d/, M = /^(0x|0X)/, j = /^[0-7]+$/, N = /^\d+$/, B = /^[\dA-Fa-f]+$/, q = /[\u0000\u0009\u000A\u000D #%/:?@[\\]]/, G = /[\u0000\u0009\u000A\u000D #/:?@[\\]]/, U = /^[\u0000-\u001F ]+|[\u0000-\u001F ]+$/g, z = /[\u0009\u000A\u000D]/g, parseHost = function(t, r) {
            ...
            o = 0; o < r; o++) {
                if ("" == (i = d[o]))
                    return t;
                if (l = 10,
                i.length > 1 && "0" == i.charAt(0) && (l = M.test(i) ? 16 : 8,
                i = i.slice(8 == l ? 1 : 2)),
                "" === i)
                    u = 0;
                else {
                    if (!(10 == l ? N : 8 == l ? j : B).test(i))
                        return t;
                    u = parseInt(i, l)
                }
                a.push(u)
            ...
            var r, a, o, i, l, u, c, d = [0, 0, 0, 0, 0, 0, 0, 0], h = 0, p = null, m = 0, char = function() {
                return t.charAt(m)
            };
            if (":" == char()) {
                if (":" != t.charAt(1))
            ...
            for (; char(); ) {
                if (8 == h)
                    return;
                if (":" != char()) {
                    for (r = a = 0; a < 4 && B.test(char()); )
                        r = 16 * r + parseInt(char(), 16),
                        m++,
                        a++;
                    if ("." == char()) {
                        if (0 == a)
        ...
        }, K = {}, J = {}, $ = {}, Z = {}, ee = {}, te = {}, re = {}, ne = {}, ae = {}, oe = {}, ie = {}, se = {}, le = {}, ue = {}, ce = {}, de = {}, fe = {}, he = {}, pe = {}, me = {}, ve = {}, parseURL = function(t, r, a, i) {
            var l, u, c, d, h, p = a || K, v = 0, y = "", b = !1, _ = !1, S = !1;
            for (a || (t.scheme = "",
            t.username = "",
            t.password = "",
            t.host = null,
            ...
            l = g(r); v <= l.length; ) {
                ...
                case J:
                    if (u && (L.test(u) || "+" == u || "-" == u || "." == u))
                        ...
                        if (a && (isSpecial(t) != m(Q, y) || "file" == y && (includesCredentials(t) || null !== t.port) || "file" == t.scheme && !t.host))
                            return;
                        if (t.scheme = y,
                        a)
                            return void (isSpecial(t) && Q[t.scheme] == t.port && (t.port = null));
                        y = "",
                        "file" == t.scheme ? p = ue : isSpecial(t) && i && i.scheme == t.scheme ? p = Z : isSpecial(t) ? p = ne : "/" == l[v + 1] ? (p = ee,
                ...
                case se:
                    ...
                    if (":" != u || _) {
                        if (u == o || "/" == u || "?" == u || "#" == u || "\\" == u && isSpecial(t)) {
                            if (isSpecial(t) && "" == y)
                                return O;
                            if (a && "" == y && (includesCredentials(t) || null !== t.port))
                                return;
                            if (d = parseHost(t, y))
                                return d;
                            if (y = "",
                    ...
                    if (!W.test(u)) {
                        if (u == o || "/" == u || "?" == u || "#" == u || "\\" == u && isSpecial(t) || a) {
                            if ("" != y) {
                                ...
                                if (k > 65535)
                                    return I;
                                t.port = isSpecial(t) && k === Q[t.scheme] ? null : k,
                                y = ""
                            }
                            if (a)
                                return;
                ...
                case ue:
                    ...
                    "/" == u || "\\" == u)
                        ...
                        if (u == o)
                            ...
                            if ("#" != u) {
                                startsWithWindowsDriveLetter(l.slice(v).join("")) || (t.host = i.host,
                                t.path = i.path.slice(),
                                shortenURLsPath(t)),
                                p = he;
                                continue
                ...
                case ce:
                    ...
                    i && "file" == i.scheme && !startsWithWindowsDriveLetter(l.slice(v).join("")) && (isWindowsDriveLetter(i.path[0], !0) ? t.path.push(i.path[0]) : t.host = i.host),
                    p = he;
                    continue;
                case de:
                    if (u == o || "/" == u || "\\" == u || "?" == u || "#" == u) {
                        if (!a && isWindowsDriveLetter(y))
                            p = he;
                        else if ("" == y) {
                            if (t.host = "",
                            a)
                ...
                case he:
                    if (u == o || "/" == u || "\\" == u && isSpecial(t) || !a && ("?" == u || "#" == u)) {
                        if (".." === (h = (h = y).toLowerCase()) || "%2e." === h || ".%2e" === h || "%2e%2e" === h ? (shortenURLsPath(t),
                        "/" == u || "\\" == u && isSpecial(t) || t.path.push("")) : isSingleDot(y) ? "/" == u || "\\" == u && isSpecial(t) || t.path.push("") : ("file" == t.scheme && !t.path.length && isWindowsDriveLetter(y) && (t.host && (t.host = ""),
                        y = y.charAt(0) + ":"),
                        t.path.push(y)),
                        y = "",
                ...
                case pe:
                    "?" == u ? (t.query = "",
                    p = me) : "#" == u ? (t.fragment = "",
                    p = ve) : u != o && (t.path[0] += percentEncode(u, H));
                    break;
                case me:
                    a || "#" != u ? u != o && ("'" == u && isSpecial(t) ? t.query += "%27" : t.query += "#" == u ? "%23" : percentEncode(u, H)) : (t.fragment = "",
                    p = ve);
                    break;
                case ve:
            ...
            var r, a, o = p(this, ge, "URL"), i = arguments.length > 1 ? arguments[1] : void 0, u = String(t), c = P(o, {
                type: "URL"
            });
            if (void 0 !== i)
                if (i instanceof ge)
                    r = w(i);
                else if (a = parseURL(r = {}, String(i)))
                    throw TypeError(a);
            if (a = parseURL(c, u, null, r))
                throw TypeError(a);
        ...
        }, ye = ge.prototype, serializeURL = function() {
            var t = w(this)
              , r = t.scheme
              , a = t.username
              , o = t.password
        ...
        if (l && d(ye, {
            ...
            username: accessorDescriptor(getUsername, (function(t) {
                ...
                if (!cannotHaveUsernamePasswordPort(r)) {
                    ...
                    for (var o = 0; o < a.length; o++)
                        r.username += percentEncode(a[o], V)
                }
            }
            )),
            password: accessorDescriptor(getPassword, (function(t) {
                ...
                if (!cannotHaveUsernamePasswordPort(r)) {
                    r.password = "";
                    for (var o = 0; o < a.length; o++)
                        r.password += percentEncode(a[o], V)
                }
            }
            )),
            ...
            hash: accessorDescriptor(getHash, (function(t) {
                ...
                r.fragment = "",
                parseURL(r, t, ve)) : r.fragment = null
            }
            ))
        }),
    ...
    , function(t, r, a) {
        ...
        var o = 2147483647
          ...
          , encode = function(t) {
            var r, a, i = [], l = (t = function(t) {
                for (var r = [], a = 0, o = t.length; a < o; ) {
                    var i = t.charCodeAt(a++);
                    if (i >= 55296 && i <= 56319 && a < o) {
                        var l = t.charCodeAt(a++);
                        56320 == (64512 & l) ? r.push(((1023 & i) << 10) + (1023 & l) + 65536) : (r.push(i),
                        a--)
                    } else
                        r.push(i)
                }
                return r
            }(t)).length, h = 128, p = 0, m = 72;
            for (r = 0; r < t.length; r++)
                (a = t[r]) < 128 && i.push(d(a));
            var v = i.length
              , g = v;
            for (v && i.push("-"); g < l; ) {
                var y = o;
                ...
                r = 0; r < t.length; r++) {
                    ...
                    if (a == h) {
                        for (var _ = p, S = 36; ; S += 36) {
                            ...
                            var C = _ - A
                              , R = 36 - A;
                            i.push(d(digitToBasic(A + C % R))),
                            _ = c(C / R)
                        }
                        i.push(d(digitToBasic(_))),
                        m = adapt(p, b, g == v),
                        p = 0,
                        ++g
                    }
        ...
        t.exports = function(t) {
            var r, a, o = [], u = t.toLowerCase().replace(l, ".").split(".");
            for (r = 0; r < u.length; r++)
                a = u[r],
                o.push(i.test(a) ? "xn--" + encode(a) : a);
            return o.join(".")
        }
    }
    , function(t, r, a) {
        ...
        var o = a(10)
          ...
          , deserialize = function(t) {
            ...
            try {
                ...
                for (; a; )
                    r = r.replace(percentSequence(a--), percentDecode);
                return r
            }
        }
          , M = /[!'()~]|%20/g
          ...
          , updateSearchParams = function(t) {
            ...
            parseSearchParams(this.entries, t)
        }
          ...
          , N = h((function Iterator(t, r) {
            ...
            var t = D(this)
              ...
              , a = t.iterator.next()
              , o = a.value;
            return a.done || (a.value = "keys" === r ? o.key : "values" === r ? o.value : [o.key, o.value]),
            a
        }
        ))
          , B = function URLSearchParams() {
            m(this, B, T);
            var t, r, a, o, i, l, u, c, d, h = arguments.length > 0 ? arguments[0] : void 0, p = this, g = [];
            if (O(p, {
                type: T,
                entries: g,
                updateURL: function() {},
                ...
                if (_(h))
                    if ("function" == typeof (t = R(h)))
                        for (a = (r = t.call(h)).next; !(o = a.call(r)).done; ) {
                            if ((u = (l = (i = C(b(o.value))).next).call(i)).done || (c = l.call(i)).done || !l.call(i).done)
                    ...
                    parseSearchParams(g, "string" == typeof h ? "?" === h.charAt(0) ? h.slice(1) : h : h + "")
        }
          , q = B.prototype;
        c(q, {
            ...
            set: function set(t, r) {
                validateArgumentsLength(arguments.length, 1);
                for (var a, o = I(this), i = o.entries, l = !1, u = t + "", c = r + "", d = 0; d < i.length; d++)
                    (a = i[d]).key === u && (l ? i.splice(d--, 1) : (l = !0,
                    a.value = c));
                l || i.push({
                    key: u,
                    value: c
            ...
            sort: function sort() {
                var t, r, a, o = I(this), i = o.entries, l = i.slice();
                for (i.length = 0,
                a = 0; a < l.length; a++) {
                    for (t = l[a],
                    r = 0; r < a; r++)
            ...
            forEach: function forEach(t) {
                for (var r, a = I(this).entries, o = g(t, arguments.length > 1 ? arguments[1] : void 0, 3), i = 0; i < a.length; )
        ...
        u(q, x, q.entries),
        u(q, "toString", (function toString() {
            for (var t, r = I(this).entries, a = [], o = 0; o < r.length; )
                t = r[o++],
                a.push(serialize(t.key) + "=" + serialize(t.value));
            return a.join("&")
        }
        ), {
            enumerable: !0
        ...
        l || "function" != typeof P || "function" != typeof w || o({
            ...
            fetch: function fetch(t) {
                var r, a, o, i = [t];
                return arguments.length > 1 && (_(r = arguments[1]) && (a = r.body,
                y(a) === T && ((o = r.headers ? new w(r.headers) : new w).has("content-type") || o.set("content-type", "application/x-www-form-urlencoded;charset=UTF-8"),
                r = S(r, {
                    body: A(0, String(a)),
                    headers: A(0, o)
                }))),
    ...
    , function(t, r, a) {
        !function(t) {
            ...
            var d = 16384
              , h = function() {
                ...
                SimpleQueue.prototype.forEach = function(t) {
                    for (var r = this._cursor, a = this._front, o = a._elements; !(r === o.length && void 0 === a._next || r === o.length && (r = 0,
                    0 === (o = (a = a._next)._elements).length)); )
                        t(o[r]),
                        ++r
                }
                ,
            ...
            function ReadableStreamReaderGenericInitialize(t, r) {
                ...
                r._reader = t,
                "readable" === r._state ? defaultReaderClosedPromiseInitialize(t) : "closed" === r._state ? defaultReaderClosedPromiseInitializeAsResolved(t) : defaultReaderClosedPromiseInitializeAsRejected(t, r._storedError)
            }
            ...
            function defaultReaderClosedPromiseInitializeAsRejected(t, r) {
                ...
                defaultReaderClosedPromiseReject(t, r)
            }
            function defaultReaderClosedPromiseInitializeAsResolved(t) {
                defaultReaderClosedPromiseInitialize(t),
                defaultReaderClosedPromiseResolve(t)
            }
            ...
            var v, g, y = function() {
                function ReadableStreamDefaultReader(t) {
                    ...
                    ReadableStreamReaderGenericInitialize(this, t),
                    this._readRequests = new h
                }
            ...
            function ReadableStreamDefaultReaderRead(t) {
                ...
                return r._disturbed = !0,
                "closed" === r._state ? promiseResolvedWith(ReadableStreamCreateReadResult(void 0, !0, t._forAuthorCode)) : "errored" === r._state ? promiseRejectedWith(r._storedError) : r._readableStreamController[m]()
            }
            ...
            ,
            g = v,
            Object.defineProperty(g, r.asyncIterator, {
                enumerable: !1
            }));
            var b = {
                next: function() {
                    ...
                    return void 0 === t._ownerReadableStream ? promiseRejectedWith(readerLockException("iterate")) : transformPromiseWith(ReadableStreamDefaultReaderRead(t), (function(r) {
                        var a = r.done;
                        return a && ReadableStreamReaderGenericRelease(t),
                ...
                return: function(t) {
                    ...
                    if (!1 === this._preventCancel) {
                        ...
                        return ReadableStreamReaderGenericRelease(r),
            ...
            function AcquireReadableStreamAsyncIterator(t, r) {
                ...
                var a = AcquireReadableStreamDefaultReader(t)
                  , o = Object.create(b);
                return o._asyncIteratorReader = a,
                o._preventCancel = Boolean(r),
                o
            }
            ...
            function DequeueValue(t) {
                ...
                return t._queueTotalSize -= r.size,
            ...
            var _ = r("[[AbortSteps]]")
              ...
              , A = function() {
                function WritableStream(t, r) {
                    ...
                    void 0 === o && (o = 1),
                    SetUpWritableStreamDefaultControllerFromUnderlyingSink(this, t, o = ValidateAndNormalizeHighWaterMark(o), i)
                }
                return Object.defineProperty(WritableStream.prototype, "locked", {
                    get: function() {
                        if (!1 === IsWritableStream(this))
            ...
            function CreateWritableStream(t, r, a, o, i, l) {
                ...
                return InitializeWritableStream(u),
            ...
            function WritableStreamAbort(t, r) {
                var a = t._state;
                if ("closed" === a || "errored" === a)
                    return promiseResolvedWith(void 0);
                if (void 0 !== t._pendingAbortRequest)
                    return t._pendingAbortRequest._promise;
                var o = !1;
                "erroring" === a && (o = !0,
                r = void 0);
                ...
                return t._pendingAbortRequest._promise = i,
                !1 === o && WritableStreamStartErroring(t, r),
                i
            }
            function WritableStreamClose(t) {
                var r = t._state;
                if ("closed" === r || "errored" === r)
                    return promiseRejectedWith(new TypeError("The stream (in " + r + " state) is not in the writable state and cannot be closed"));
                var a = newPromise((function(r, a) {
                  ...
                  , o = t._writer;
                return void 0 !== o && !0 === t._backpressure && "writable" === r && defaultWriterReadyPromiseResolve(o),
            ...
            function WritableStreamStartErroring(t, r) {
                ...
                !1 === WritableStreamHasOperationMarkedInFlight(t) && !0 === a._started && WritableStreamFinishErroring(t)
            }
            function WritableStreamFinishErroring(t) {
                t._state = "errored",
                t._writableStreamController[S]();
                ...
                void 0 !== t._pendingAbortRequest) {
                    ...
                    if (t._pendingAbortRequest = void 0,
                    !0 === a._wasAlreadyErroring)
                        return a._reject(r),
                        void WritableStreamRejectCloseAndClosedPromiseIfNeeded(t);
                    uponPromise(t._writableStreamController[_](a._reason), (function() {
                        a._resolve(),
                        WritableStreamRejectCloseAndClosedPromiseIfNeeded(t)
                    }
                    ), (function(r) {
                        a._reject(r),
                        WritableStreamRejectCloseAndClosedPromiseIfNeeded(t)
            ...
            function WritableStreamFinishInFlightWrite(t) {
                t._inFlightWriteRequest._resolve(void 0),
                t._inFlightWriteRequest = void 0
            }
            ...
            function WritableStreamFinishInFlightClose(t) {
                ...
                t._inFlightCloseRequest = void 0,
                "erroring" === t._state && (t._storedError = void 0,
                void 0 !== t._pendingAbortRequest && (t._pendingAbortRequest._resolve(),
                t._pendingAbortRequest = void 0)),
                t._state = "closed";
                var r = t._writer;
            ...
            function WritableStreamFinishInFlightCloseWithError(t, r) {
                ...
                t._inFlightCloseRequest = void 0,
                void 0 !== t._pendingAbortRequest && (t._pendingAbortRequest._reject(r),
                t._pendingAbortRequest = void 0),
                WritableStreamDealWithRejection(t, r)
            }
            ...
            function WritableStreamRejectCloseAndClosedPromiseIfNeeded(t) {
                void 0 !== t._closeRequest && (t._closeRequest._reject(t._storedError),
                t._closeRequest = void 0);
                var r = t._writer;
            ...
            function WritableStreamUpdateBackpressure(t, r) {
                var a = t._writer;
                void 0 !== a && r !== t._backpressure && (!0 === r ? defaultWriterReadyPromiseReset(a) : defaultWriterReadyPromiseResolve(a)),
                t._backpressure = r
            }
            var C = function() {
                function WritableStreamDefaultWriter(t) {
                    ...
                    var r = t._state;
                    if ("writable" === r)
                        !1 === WritableStreamCloseQueuedOrInFlight(t) && !0 === t._backpressure ? defaultWriterReadyPromiseInitialize(this) : defaultWriterReadyPromiseInitializeAsResolved(this),
            ...
            function WritableStreamDefaultWriterWrite(t, r) {
                ...
                return WritableStreamDefaultControllerWrite(o, r, i),
                u
            }
            var R = function() {
                ...
                WritableStreamDefaultController.prototype[_] = function(t) {
                    ...
                    return WritableStreamDefaultControllerClearAlgorithms(this),
                    r
                }
                ,
            ...
            function SetUpWritableStreamDefaultController(t, r, a, o, i, l, u, c) {
                ...
                uponPromise(promiseResolvedWith(a()), (function() {
                    r._started = !0,
                    WritableStreamDefaultControllerAdvanceQueueIfNeeded(r)
                }
                ), (function(a) {
                    r._started = !0,
                    WritableStreamDealWithRejection(t, a)
                }
                ))
            }
            ...
            function WritableStreamDefaultControllerGetChunkSize(t, r) {
                try {
                    ...
                    return WritableStreamDefaultControllerErrorIfNeeded(t, r),
                    1
                }
            }
            ...
            function WritableStreamDefaultControllerWrite(t, r, a) {
                ...
                !1 === WritableStreamCloseQueuedOrInFlight(i) && "writable" === i._state && WritableStreamUpdateBackpressure(i, WritableStreamDefaultControllerGetBackpressure(t)),
                WritableStreamDefaultControllerAdvanceQueueIfNeeded(t)
            }
            ...
            function WritableStreamDefaultControllerProcessWrite(t, r) {
                ...
                uponPromise(t._writeAlgorithm(r), (function() {
                    WritableStreamFinishInFlightWrite(a);
                    var r = a._state;
                    if (DequeueValue(t),
                    !1 === WritableStreamCloseQueuedOrInFlight(a) && "writable" === r) {
            ...
            function WritableStreamDefaultControllerError(t, r) {
                var a = t._controlledWritableStream;
                WritableStreamDefaultControllerClearAlgorithms(t),
                WritableStreamStartErroring(a, r)
            }
            ...
            function defaultWriterReadyPromiseInitialize(t) {
                t._readyPromise = newPromise((function(r, a) {
                    t._readyPromise_resolve = r,
                    t._readyPromise_reject = a
                }
                )),
            ...
            function defaultWriterReadyPromiseInitializeAsResolved(t) {
                defaultWriterReadyPromiseInitialize(t),
                defaultWriterReadyPromiseResolve(t)
            }
            ...
            function ReadableStreamPipeTo(t, r, a, o, i, l) {
                ...
                return newPromise((function(p, m) {
                    ...
                    function pipeStep() {
                        return !0 === d ? promiseResolvedWith(!0) : PerformPromiseThen(c._readyPromise, (function() {
                            return PerformPromiseThen(ReadableStreamDefaultReaderRead(u), (function(t) {
                                return !0 === t.done || (h = PerformPromiseThen(WritableStreamDefaultWriterWrite(c, t.value), void 0, noop),
                                !1)
                            }
                            ))
                        }
                    ...
                    function shutdownWithAction(t, a, o) {
                        ...
                        !0 !== d && (d = !0,
                        "writable" === r._state && !1 === WritableStreamCloseQueuedOrInFlight(r) ? uponFulfillment(waitForWritesToFinish(), doTheRest) : doTheRest())
                    }
                    function shutdown(t, a) {
                        !0 !== d && (d = !0,
                        "writable" === r._state && !1 === WritableStreamCloseQueuedOrInFlight(r) ? uponFulfillment(waitForWritesToFinish(), (function() {
                            return finalize(t, a)
                        }
                        )) : finalize(t, a))
                    }
            ...
            var w = function() {
                ...
                ReadableStreamDefaultController.prototype[p] = function(t) {
                    ...
                    return ReadableStreamDefaultControllerClearAlgorithms(this),
                    r
                }
                ,
                ReadableStreamDefaultController.prototype[m] = function() {
                    ...
                    if (this._queue.length > 0) {
                        ...
                        return !0 === this._closeRequested && 0 === this._queue.length ? (ReadableStreamDefaultControllerClearAlgorithms(this),
                        ReadableStreamClose(t)) : ReadableStreamDefaultControllerCallPullIfNeeded(this),
                        promiseResolvedWith(ReadableStreamCreateReadResult(r, !1, t._reader._forAuthorCode))
                    }
                    var a = ReadableStreamAddReadRequest(t);
                    return ReadableStreamDefaultControllerCallPullIfNeeded(this),
                    a
                }
                ,
            ...
            function ReadableStreamDefaultControllerCallPullIfNeeded(t) {
                !1 !== ReadableStreamDefaultControllerShouldCallPull(t) && (!0 !== t._pulling ? (t._pulling = !0,
                uponPromise(t._pullAlgorithm(), (function() {
                    t._pulling = !1,
            ...
            function ReadableStreamDefaultControllerClose(t) {
                var r = t._controlledReadableStream;
                t._closeRequested = !0,
                0 === t._queue.length && (ReadableStreamDefaultControllerClearAlgorithms(t),
            ...
            function ReadableStreamDefaultControllerEnqueue(t, r) {
                ...
                if (!0 === IsReadableStreamLocked(a) && ReadableStreamGetNumReadRequests(a) > 0)
                    ...
                    try {
                        ...
                        throw ReadableStreamDefaultControllerError(t, r),
                        r
                    }
                    try {
            ...
            function ReadableStreamDefaultControllerError(t, r) {
                var a = t._controlledReadableStream;
                "readable" === a._state && (ResetQueue(t),
            ...
            function ReadableStreamTee(t, r) {
                var a, o, i, l, u, c = AcquireReadableStreamDefaultReader(t), d = !1, h = !1, p = !1, m = newPromise((function(t) {
                    u = t
                }
                ));
                function pullAlgorithm() {
                    return !0 === d || (d = !0,
                    setPromiseIsHandledToTrue(transformPromiseWith(ReadableStreamDefaultReaderRead(c), (function(t) {
                        if (d = !1,
                        !0 === t.done)
                            return !1 === h && ReadableStreamDefaultControllerClose(i._readableStreamController),
                            void (!1 === p && ReadableStreamDefaultControllerClose(l._readableStreamController));
                        var r = t.value
                          , a = r
                          , o = r;
                        !1 === h && ReadableStreamDefaultControllerEnqueue(i._readableStreamController, a),
                        !1 === p && ReadableStreamDefaultControllerEnqueue(l._readableStreamController, o)
                    }
                    )))),
                ...
                function startAlgorithm() {}
                return i = CreateReadableStream(startAlgorithm, pullAlgorithm, cancel1Algorithm),
            ...
            var x = Number.isInteger || function(t) {
              ...
              , T = function() {
                ...
                ReadableStreamBYOBRequest.prototype.respond = function(t) {
                    ...
                    ReadableByteStreamControllerRespond(this._associatedReadableByteStreamController, t)
                }
                ,
                ReadableStreamBYOBRequest.prototype.respondWithNewView = function(t) {
                    ...
                    ReadableByteStreamControllerRespondWithNewView(this._associatedReadableByteStreamController, t)
                }
                ,
              ...
              , E = function() {
                ...
                return Object.defineProperty(ReadableByteStreamController.prototype, "byobRequest", {
                    get: function() {
                        ...
                        if (void 0 === this._byobRequest && this._pendingPullIntos.length > 0) {
                            ...
                            SetUpReadableStreamBYOBRequest(a, this, r),
                            this._byobRequest = a
                        }
                ...
                ReadableByteStreamController.prototype.enqueue = function(t) {
                    ...
                    IsDetachedBuffer(t.buffer),
                    ReadableByteStreamControllerEnqueue(this, t)
                }
                ,
                ...
                ReadableByteStreamController.prototype[p] = function(t) {
                    ...
                    ResetQueue(this);
                    var r = this._cancelAlgorithm(t);
                    return ReadableByteStreamControllerClearAlgorithms(this),
                    r
                }
                ,
                ReadableByteStreamController.prototype[m] = function() {
                    ...
                    return ReadableByteStreamControllerCallPullIfNeeded(this),
                    u
                }
                ,
            ...
            function ReadableByteStreamControllerCallPullIfNeeded(t) {
                !1 !== ReadableByteStreamControllerShouldCallPull(t) && (!0 !== t._pulling ? (t._pulling = !0,
                uponPromise(t._pullAlgorithm(), (function() {
                    t._pulling = !1,
                    !0 === t._pullAgain && (t._pullAgain = !1,
            ...
            function ReadableByteStreamControllerFillPullIntoDescriptorFromQueue(t, r) {
                ...
                for (var h = t._queue; c > 0; ) {
                    ...
                    p.byteLength === m ? h.shift() : (p.byteOffset += m,
                    p.byteLength -= m),
                    t._queueTotalSize -= m,
            ...
            function ReadableByteStreamControllerHandleQueueDrain(t) {
                0 === t._queueTotalSize && !0 === t._closeRequested ? (ReadableByteStreamControllerClearAlgorithms(t),
                ReadableStreamClose(t._controlledReadableByteStream)) : ReadableByteStreamControllerCallPullIfNeeded(t)
            }
            ...
            function ReadableByteStreamControllerProcessPullIntoDescriptorsUsingQueue(t) {
                for (; t._pendingPullIntos.length > 0; ) {
                    if (0 === t._queueTotalSize)
                        return;
                    var r = t._pendingPullIntos.peek();
                    !0 === ReadableByteStreamControllerFillPullIntoDescriptorFromQueue(t, r) && (ReadableByteStreamControllerShiftPendingPullInto(t),
            ...
            function ReadableByteStreamControllerPullInto(t, r) {
                ...
                if (t._pendingPullIntos.length > 0)
                    return t._pendingPullIntos.push(l),
                    ReadableStreamAddReadIntoRequest(a);
                if ("closed" === a._state)
                    return promiseResolvedWith(ReadableStreamCreateReadResult(new i(l.buffer,l.byteOffset,0), !0, a._reader._forAuthorCode));
                if (t._queueTotalSize > 0) {
                    if (!0 === ReadableByteStreamControllerFillPullIntoDescriptorFromQueue(t, l)) {
                        ...
                        return ReadableByteStreamControllerHandleQueueDrain(t),
                    ...
                    if (!0 === t._closeRequested) {
                        ...
                        return ReadableByteStreamControllerError(t, c),
                        promiseRejectedWith(c)
                    }
                }
                t._pendingPullIntos.push(l);
                var d = ReadableStreamAddReadIntoRequest(a);
                return ReadableByteStreamControllerCallPullIfNeeded(t),
                d
            }
            function ReadableByteStreamControllerRespondInClosedState(t, r) {
                ...
                if (!0 === ReadableStreamHasBYOBReader(a))
                    for (; ReadableStreamGetNumReadIntoRequests(a) > 0; )
                        ReadableByteStreamControllerCommitPullIntoDescriptor(a, ReadableByteStreamControllerShiftPendingPullInto(t))
            }
            function ReadableByteStreamControllerRespondInReadableState(t, r, a) {
                if (a.bytesFilled + r > a.byteLength)
                    throw new RangeError("bytesWritten out of range");
                if (ReadableByteStreamControllerFillHeadPullIntoDescriptor(t, r, a),
            ...
            function ReadableByteStreamControllerRespondInternal(t, r) {
                ...
                if ("closed" === t._controlledReadableByteStream._state) {
                    ...
                    ReadableByteStreamControllerRespondInReadableState(t, r, a);
                ReadableByteStreamControllerCallPullIfNeeded(t)
            }
            function ReadableByteStreamControllerShiftPendingPullInto(t) {
                var r = t._pendingPullIntos.shift();
                return ReadableByteStreamControllerInvalidateBYOBRequest(t),
                r
            }
            ...
            function ReadableByteStreamControllerClose(t) {
                ...
                if (t._queueTotalSize > 0)
                    ...
                    if (t._pendingPullIntos.length > 0 && t._pendingPullIntos.peek().bytesFilled > 0) {
                        ...
                        throw ReadableByteStreamControllerError(t, a),
                        a
                    }
            ...
            function ReadableByteStreamControllerEnqueue(t, r) {
                ...
                !0 === ReadableStreamHasDefaultReader(a) ? 0 === ReadableStreamGetNumReadRequests(a) ? ReadableByteStreamControllerEnqueueChunkToQueue(t, u, i, l) : ReadableStreamFulfillReadRequest(a, new Uint8Array(u,i,l), !1) : !0 === ReadableStreamHasBYOBReader(a) ? (ReadableByteStreamControllerEnqueueChunkToQueue(t, u, i, l),
                ReadableByteStreamControllerProcessPullIntoDescriptorsUsingQueue(t)) : ReadableByteStreamControllerEnqueueChunkToQueue(t, u, i, l),
                ReadableByteStreamControllerCallPullIfNeeded(t)
            }
            function ReadableByteStreamControllerError(t, r) {
                var a = t._controlledReadableByteStream;
                "readable" === a._state && (ReadableByteStreamControllerClearPendingPullIntos(t),
                ResetQueue(t),
                ReadableByteStreamControllerClearAlgorithms(t),
                ReadableStreamError(a, r))
            }
            ...
            function ReadableByteStreamControllerRespondWithNewView(t, r) {
                ...
                a.buffer = r.buffer,
                ReadableByteStreamControllerRespondInternal(t, r.byteLength)
            }
            ...
            var O = function() {
                ...
                ReadableStreamBYOBReader.prototype.read = function(t) {
                    return IsReadableStreamBYOBReader(this) ? void 0 === this._ownerReadableStream ? promiseRejectedWith(readerLockException("read from")) : ArrayBuffer.isView(t) ? (IsDetachedBuffer(t.buffer),
                    0 === t.byteLength ? promiseRejectedWith(new TypeError("view must have non-zero byteLength")) : ReadableStreamBYOBReaderRead(this, t)) : promiseRejectedWith(new TypeError("view must be an array buffer view")) : promiseRejectedWith(byobReaderBrandCheckException("read"))
                }
                ,
            ...
            function ReadableStreamBYOBReaderRead(t, r) {
                ...
                return a._disturbed = !0,
                "errored" === a._state ? promiseRejectedWith(a._storedError) : ReadableByteStreamControllerPullInto(a._readableStreamController, r)
            }
            ...
            var I = function() {
                function ReadableStream(t, r) {
                    ...
                    if ("bytes" === String(i)) {
                        ...
                        void 0 === o && (o = 0),
                        SetUpReadableByteStreamControllerFromUnderlyingSource(this, t, o = ValidateAndNormalizeHighWaterMark(o))
                    } else {
                        if (void 0 !== i)
                            throw new RangeError("Invalid type is specified");
                        var l = MakeSizeAlgorithmFromSizeFunction(a);
                        void 0 === o && (o = 1),
                        SetUpReadableStreamDefaultControllerFromUnderlyingSource(this, t, o = ValidateAndNormalizeHighWaterMark(o), l)
                    }
                }
                return Object.defineProperty(ReadableStream.prototype, "locked", {
                    get: function() {
                        if (!1 === IsReadableStream(this))
                ...
                ReadableStream.prototype.getReader = function(t) {
                    ...
                    if (void 0 === r)
                        return AcquireReadableStreamDefaultReader(this, !0);
                    if ("byob" === (r = String(r)))
                        return AcquireReadableStreamBYOBReader(this, !0);
                ...
                ReadableStream.prototype.pipeThrough = function(t, r) {
                    ...
                    return setPromiseIsHandledToTrue(ReadableStreamPipeTo(this, a, l, u, c, d)),
                    o
                }
                ,
                ReadableStream.prototype.pipeTo = function(t, r) {
                    var a = void 0 === r ? {} : r
                      ...
                      , l = a.preventCancel
                      , u = a.signal;
                    return !1 === IsReadableStream(this) ? promiseRejectedWith(streamBrandCheckException$1("pipeTo")) : !1 === IsWritableStream(t) ? promiseRejectedWith(new TypeError("ReadableStream.prototype.pipeTo's first argument must be a WritableStream")) : (o = Boolean(o),
                    i = Boolean(i),
                    l = Boolean(l),
                    void 0 === u || isAbortSignal(u) ? !0 === IsReadableStreamLocked(this) ? promiseRejectedWith(new TypeError("ReadableStream.prototype.pipeTo cannot be used on a locked ReadableStream")) : !0 === IsWritableStreamLocked(t) ? promiseRejectedWith(new TypeError("ReadableStream.prototype.pipeTo cannot be used on a locked WritableStream")) : ReadableStreamPipeTo(this, t, o, i, l, u) : promiseRejectedWith(new TypeError("ReadableStream.prototype.pipeTo's signal option must be an AbortSignal")))
                }
                ,
            ...
            function CreateReadableStream(t, r, a, o, i) {
                ...
                return InitializeReadableStream(l),
            ...
            function ReadableStreamCancel(t, r) {
                return t._disturbed = !0,
                "closed" === t._state ? promiseResolvedWith(void 0) : "errored" === t._state ? promiseRejectedWith(t._storedError) : (ReadableStreamClose(t),
                transformPromiseWith(t._readableStreamController[p](r), noop))
            }
            ...
            var D = function() {
              ...
              , W = function() {
                function TransformStream(t, r, a) {
                    ...
                    InitializeTransformStream(this, newPromise((function(t) {
                        d = t
                    }
                    )), i, c, u, h),
            ...
            function InitializeTransformStream(t, r, a, o, i, l) {
                ...
                function cancelAlgorithm(r) {
                    return TransformStreamErrorWritableAndUnblockWrite(t, r),
                    promiseResolvedWith(void 0)
                }
                t._writable = CreateWritableStream(startAlgorithm, writeAlgorithm, closeAlgorithm, abortAlgorithm, a, o),
            ...
            function SetUpTransformStreamDefaultControllerFromTransformer(t, r) {
                var a = Object.create(M.prototype)
                  , transformAlgorithm = function(t) {
                    try {
                        return TransformStreamDefaultControllerEnqueue(a, t),
                        promiseResolvedWith(void 0)
                    } catch (t) {
                        return promiseRejectedWith(t)
                    }
            ...
            function TransformStreamDefaultControllerEnqueue(t, r) {
                ...
                try {
                    ...
                    throw TransformStreamErrorWritableAndUnblockWrite(a, t),
                    a._readable._storedError
                }
            ...
            function TransformStreamDefaultControllerPerformTransform(t, r) {
                return transformPromiseWith(t._transformAlgorithm(r), void 0, (function(r) {
                    throw TransformStreamError(t._controlledTransformStream, r),
                    r
                }
                ))
            }
            function TransformStreamDefaultControllerTerminate(t) {
                ...
                !0 === ReadableStreamDefaultControllerCanCloseOrEnqueue(a) && ReadableStreamDefaultControllerClose(a),
            ...
            function TransformStreamDefaultSinkAbortAlgorithm(t, r) {
                return TransformStreamError(t, r),
                promiseResolvedWith(void 0)
            }
            function TransformStreamDefaultSinkCloseAlgorithm(t) {
                var r = t._readable
                  ...
                  , o = a._flushAlgorithm();
                return TransformStreamDefaultControllerClearAlgorithms(a),
                transformPromiseWith(o, (function() {
                    if ("errored" === r._state)
                    ...
                    throw TransformStreamError(t, a),
                    r._storedError
                }
                ))
            }
            function TransformStreamDefaultSourcePullAlgorithm(t) {
                return TransformStreamSetBackpressure(t, !1),
        ...
        t.exports = function(t, r, a) {
            ...
            if (l(t, "function" != typeof A || !(_ || C.forEach && !m((function() {
                ...
                T || ((R = r((function(r, a) {
                    h(r, R, t);
                    var o = y(new A, r, R);
                    return null != a && d(a, o[S], o, b),
                    o
                }
                ))).prototype = C,
                C.constructor = R),
                (x || E) && (fixMethod("delete"),
                fixMethod("has"),
                b && fixMethod("get")),
                (E || w) && fixMethod(S),
    ...
    , function(t, r, a) {
        var o = a(39)
          ...
          , v = t.exports = {
            ...
            onFreeze: function(t) {
                return d && v.REQUIRED && m(t) && !l(t, h) && setMetadata(t),
                t
            }
        };
        o[h] = !0
    ...
    , function(t, r, a) {
        ...
        t.exports = function(t, r, a) {
            var l, u;
            return i && "function" == typeof (l = r.constructor) && l !== a && o(u = l.prototype) && u !== a.prototype && i(t, u),
            t
        }
    }
    , function(t, r, a) {
        ...
        t.exports = {
                ...
                return l(p.prototype, {
                    ...
                    forEach: function forEach(t) {
                        for (var r, a = g(this), o = u(t, arguments.length > 1 ? arguments[1] : void 0, 3); r = r ? r.next : a.first; )
                            for (o(r.value, r.key, this); r && r.removed; )
                                r = r.previous
                    },
                    has: function has(t) {
            ...
            setStrong: function(t, r, a) {
                ...
                h(t, r, (function(t, r) {
                    ...
                    for (var t = l(this), r = t.kind, a = t.last; a && a.removed; )
                        a = a.previous;
    ...
    , function(t, r, a) {
        "use strict";
        var o, i = a(11), l = a(121), u = a(147), c = a(146), d = a(155), h = a(22), p = a(33).enforce, m = a(34), v = !i.ActiveXObject && "ActiveXObject"in i, g = Object.isExtensible, wrapper = function(t) {
            return function WeakMap() {
                return t(this, arguments.length ? arguments[0] : void 0)
            }
        }, y = t.exports = c("WeakMap", wrapper, d);
        if (m && v) {
            o = d.getConstructor(wrapper, "WeakMap", !0),
            u.REQUIRED = !0;
            var b = y.prototype
              , _ = b.delete
              , S = b.has
            ...
            l(b, {
                delete: function(t) {
                    if (h(t) && !g(t)) {
                        ...
                        _.call(this, t) || r.frozen.delete(t)
                    }
                ...
                get: function get(t) {
                    if (h(t) && !g(t)) {
                        var r = p(this);
                        return r.frozen || (r.frozen = new o),
                        S.call(this, t) ? A.call(this, t) : r.frozen.get(t)
                    }
                ...
                set: function set(t, r) {
                    if (h(t) && !g(t)) {
                        ...
                        S.call(this, t) ? C.call(this, t, r) : a.frozen.set(t, r)
                    } else
                        C.call(this, t, r);
                    return this
                }
            ...
            getConstructor: function(t, r, a, h) {
                var m = t((function(t, o) {
                  ...
                  , define = function(t, r, a) {
                    var o = y(t)
                      , u = i(l(r), !0);
                    return !0 === u ? uncaughtFrozenStore(o).set(r, a) : u[o.id] = a,
                    t
                };
    ...
    , function(t, r, a) {
        ...
        t.exports = function(t, r) {
            var a;
            return i(t) && ("function" != typeof (a = t.constructor) || a !== Array && !i(a.prototype) ? o(a) && null === (a = a[l]) && (a = void 0) : a = void 0),
    ...
    , function(t, r, a) {
        ...
        o({
            ...
            concat: function concat(t) {
                var r, a, o, i, l, u = c(this), m = p(u, 0), v = 0;
                for (r = -1,
    ...
    , function(t, r, a) {
        ...
        : function(t) {
          ...
          , de = function defineProperty(t, r, a) {
            ...
            var o = S(r, !0);
            return y(a),
            m(re, o) ? (a.enumerable ? (m(t, z) && t[z][o] && (t[z][o] = !1),
            a = C(a, {
                enumerable: A(0, !1)
            })) : (m(t, z) || Z(t, z, A(1, {})),
            t[z][o] = !0),
          ...
          , pe = function getOwnPropertyDescriptor(t, r) {
            ...
            if (a !== Q || !m(re, o) || m(ne, o)) {
                var i = $(a, o);
                return !i || !m(re, o) || m(a, z) && a[z][o] || (i.enumerable = !0),
                i
            }
        }
        ...
        J) && o({
            ...
            stringify: function stringify(t, r, a) {
                for (var o, i = [t], l = 1; arguments.length > l; )
                    i.push(arguments[l++]);
                if (o = r,
                (g(r) || void 0 !== t) && !ce(t))
        ...
        K.prototype[Y] || O(K.prototype, Y, K.prototype.valueOf),
        q(K, H),
        W[z] = !0
    }
    , function(t, r, a) {
        ...
        var o = a(47)
          ...
          , createMethod = function(t) {
            return function(r, a, c) {
                var d, h, p = String(l(r)), m = p.length, v = void 0 === c ? " " : String(c), g = o(a);
                return g <= m || "" == v ? p : (d = g - m,
          ...
          , createMethod = function(t) {
            return function(r) {
                for (var a, c = l(r), d = i(c), h = d.length, p = 0, m = []; h > p; )
                    a = d[p++],
                    o && !u.call(c, a) || m.push(t ? [a, c[a]] : c[a]);
                return m
            }
        };
        t.exports = {
    ...
    , function(module, exports, __w_pdfjs_require__) {
        ...
        function _unsupportedIterableToArray(t, r) {
            if (t) {
                ...
                "Map" === a || "Set" === a ? Array.from(t) : "Arguments" === a || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(a) ? _arrayLikeToArray(t, r) : void 0
            }
        }
        function _arrayLikeToArray(t, r) {
            (null == r || r > t.length) && (r = t.length);
        ...
        function _iterableToArrayLimit(t, r) {
            if ("undefined" != typeof Symbol && Symbol.iterator in Object(t)) {
                var a = []
                  ...
                  , l = void 0;
                try {
                    for (var u, c = t[Symbol.iterator](); !(o = (u = c.next()).done) && (a.push(u.value),
                    !r || a.length !== r); o = !0)
                        ;
                } catch (t) {
                    i = !0,
        ...
        var DEFAULT_RANGE_CHUNK_SIZE = 65536, RENDERING_CANCELLED_TIMEOUT = 100, createPDFNetworkStream;
        ...
        function getDocument(t) {
            ...
            for (var u in r)
                if ("url" !== u || "undefined" == typeof window)
                    if ("range" !== u)
                        if ("worker" !== u)
                            if ("data" !== u || r[u]instanceof Uint8Array)
                                o[u] = r[u];
                            else {
                                var c = r[u];
                                if ("string" == typeof c)
                                    o[u] = (0,
                                    _util.stringToBytes)(c);
                                else if ("object" !== _typeof(c) || null === c || isNaN(c.length)) {
                                    if (!(0,
                                    _util.isArrayBuffer)(c))
                    ...
                    o[u] = new URL(r[u],window.location).href;
            if (o.rangeChunkSize = o.rangeChunkSize || DEFAULT_RANGE_CHUNK_SIZE,
            ...
            "boolean" != typeof o.disableFontFace && (o.disableFontFace = _api_compatibility.apiCompatibilityParams.disableFontFace || !1),
            ...
            (0,
            _util.setVerbosityLevel)(o.verbosity),
            !l) {
                var d = {
                    verbosity: o.verbosity,
                    port: _worker_options.GlobalWorkerOptions.workerPort
                };
                l = d.port ? PDFWorker.fromPort(d) : new PDFWorker(d),
                a._worker = l
            }
            var h = a.docId;
        ...
        function _fetchDocument(t, r, a, o) {
            return t.destroyed ? Promise.reject(new Error("Worker was destroyed")) : (a && (r.length = a.length,
        ...
        var PDFDocumentProxy = function() {
            ...
            return _createClass(PDFDocumentProxy, [{
                ...
                value: function getOpenActionDestination() {
                    return (0,
                    _display_utils.deprecated)("getOpenActionDestination, use getOpenAction instead."),
            ...
            return _createClass(PDFPageProxy, [{
                ...
                value: function getAnnotations() {
                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}
                      , r = t.intent
                      , a = void 0 === r ? null : r;
                    return this.annotationsPromise && this.annotationsIntent === a || (this.annotationsPromise = this._transport.getAnnotations(this._pageIndex, a),
                ...
                value: function render(t) {
                    ...
                    C.streamReaderCancelTimeout && (clearTimeout(C.streamReaderCancelTimeout),
                    C.streamReaderCancelTimeout = null);
                    var R = b || new _display_utils.DOMCanvasFactory
                      , k = new _webgl.WebGLContext({
                        enable: c
                    });
                    C.displayReadyCapability || (C.displayReadyCapability = (0,
                    _util.createPromiseCapability)(),
                    C.operatorList = {
                        fnArray: [],
                        argsArray: [],
                    ...
                    var P = function complete(t) {
                        ...
                        r._tryCleanup(),
                        t ? (w.capability.reject(t),
                        r._abortOperatorList({
                            intentState: C,
                            reason: t
                        })) : w.capability.resolve(),
                        r._stats && (r._stats.timeEnd("Rendering"),
                    ...
                    C.renderTasks || (C.renderTasks = []),
                    C.renderTasks.push(w);
                    var x = w.task;
                    return C.displayReadyCapability.promise.then((function(t) {
                        r.pendingCleanup ? P() : (r._stats && r._stats.time("Rendering"),
                    ...
                    return new Promise((function(t, a) {
                        ...
                        !function pump() {
                            o.read().then((function(r) {
                                var a, o = r.value;
                                r.done ? t(i) : (Object.assign(i.styles, o.styles),
                ...
                value: function _startRenderPage(t, r) {
                    ...
                    a && (this._stats && this._stats.timeEnd("Page Request"),
                ...
                value: function _pumpOperatorList(t) {
                    var r = this;
                    (0,
                    _util.assert)(t.intent, 'PDFPageProxy._pumpOperatorList: Expected "intent" argument.');
                    ...
                    !function pump() {
                        a.read().then((function(t) {
                            var a = t.value;
                            t.done ? o.streamReader = null : r._transport.destroyed || (r._renderPageChunk(a, o),
                            pump())
                        }
                        ), (function(t) {
                            if (o.streamReader = null,
                            !r._transport.destroyed) {
                                if (o.operatorList) {
                ...
                value: function _abortOperatorList(t) {
                    var r = this
                      ...
                      , l = void 0 !== i && i;
                    if ((0,
                    _util.assert)(o instanceof Error || "object" === _typeof(o) && null !== o, 'PDFPageProxy._abortOperatorList: Expected "reason" argument.'),
                    a.streamReader) {
                        if (!l) {
                            if (0 !== a.renderTasks.length)
                                return;
                        ...
                        a.streamReader = null,
                        this._transport.destroyed || (Object.keys(this.intentStates).some((function(t) {
                            return r.intentStates[t] === a && (delete r.intentStates[t],
                            !0)
                        }
                        )),
                        this.cleanup())
                        ...
                        var o = new WeakMap
                          , i = {
                            data: function cloneValue(t) {
                                ...
                                var a, i;
                                if ((a = t.buffer) && (0,
                                _util.isArrayBuffer)(a))
                                    return i = r && r.includes(a) ? new t.constructor(a,t.byteOffset,t.byteLength) : new t.constructor(t),
                                    o.set(t, i),
                                    i;
                                for (var l in i = Array.isArray(t) ? [] : {},
                                o.set(t, i),
                                t) {
                                    for (var u = void 0, c = t; !(u = Object.getOwnPropertyDescriptor(c, l)); )
                                        c = Object.getPrototypeOf(c);
                                    if (void 0 !== u.value)
                                        if ("function" != typeof u.value)
                                            i[l] = cloneValue(u.value);
                                        else if (t.hasOwnProperty && t.hasOwnProperty(l))
                                            throw new Error("LoopbackPort.postMessage - cannot clone: ".concat(t[l]))
                                }
                                return i
                            }(t)
                        };
        ...
        var PDFWorker = function PDFWorkerClosure() {
            var pdfWorkerPorts = new WeakMap, isWorkerDisabled = !1, fallbackWorkerSrc, nextFakeWorkerId = 0, fakeWorkerCapability;
            ...
            function setupFakeWorkerGlobal() {
                    ...
                    var _ref10 = _asyncToGenerator(_regenerator.default.mark((function _callee() {
                        ...
                        return _regenerator.default.wrap((function _callee$(_context) {
                            for (; ; )
                                ...
                                case 0:
                                    if (mainWorkerMessageHandler = getMainThreadWorkerMessageHandler(),
                                ...
                                case 3:
                                    ...
                                    return worker = eval("require")(_getWorkerSrc()),
                                    _context.abrupt("return", worker.WorkerMessageHandler);
                                case 6:
                                    return _context.next = 8,
                                    (0,
                                    _display_utils.loadScript)(_getWorkerSrc());
                                case 8:
                ...
                return loader().then(fakeWorkerCapability.resolve, fakeWorkerCapability.reject),
            ...
            var PDFWorker = function() {
                function PDFWorker() {
                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}
                      ...
                      , l = t.verbosity
                      , u = void 0 === l ? (0,
                    _util.getVerbosityLevel)() : l;
                    if (_classCallCheck(this, PDFWorker),
                    i && pdfWorkerPorts.has(i))
                    ...
                    i)
                        return pdfWorkerPorts.set(i, this),
                ...
                return _createClass(PDFWorker, [{
                    ...
                    value: function _initialize() {
                        ...
                        if ("undefined" != typeof Worker && !isWorkerDisabled && !getMainThreadWorkerMessageHandler()) {
                            ...
                            try {
                                (0,
                                _util.isSameOrigin)(window.location.href, r) || (r = createCDNWrapper(new URL(r,window.location).href));
                                var a = new Worker(r)
                                  ...
                                  , i = function terminateEarly() {
                                    ...
                                    o.destroy(),
                                    a.terminate(),
                                    t.destroyed ? t._readyCapability.reject(new Error("Worker was destroyed")) : t._setupFakeWorker()
                                }
                                ...
                                o.on("test", (function(r) {
                                    a.removeEventListener("error", l),
                                    t.destroyed ? i() : r ? (t._messageHandler = o,
                                    t._port = a,
                                    t._webWorker = a,
                                ...
                                o.on("ready", (function(r) {
                                    if (a.removeEventListener("error", l),
                                    t.destroyed)
                                        i();
                                    else
                                        try {
                    ...
                    value: function _setupFakeWorker() {
                        ...
                        isWorkerDisabled = !0),
                        setupFakeWorkerGlobal().then((function(r) {
                            if (t.destroyed)
            ...
            return _createClass(WorkerTransport, [{
                ...
                value: function destroy() {
                    ...
                    Promise.all(r).then((function() {
                        t.fontLoader.clear(),
                        t._networkStream && t._networkStream.cancelAllRequests(new _util.AbortException("Worker was terminated.")),
                        t.messageHandler && (t.messageHandler.destroy(),
                ...
                value: function setupMessageHandler() {
                    ...
                    r.on("GetReader", (function(r, a) {
                        (0,
                        _util.assert)(t._networkStream, "GetReader - no `IPDFStream` instance available."),
                        ...
                        a.onPull = function() {
                            t._fullReader.read().then((function(t) {
                                ...
                                t.done ? a.close() : ((0,
                                _util.assert)((0,
                                _util.isArrayBuffer)(r), "GetReader - expected an ArrayBuffer."),
                    ...
                    r.on("ReaderHeadersReady", (function(r) {
                        ...
                        return i.headersReady.then((function() {
                            i.isStreamingSupported && i.isRangeSupported || (t._lastProgress && a.onProgress && a.onProgress(t._lastProgress),
                    ...
                    r.on("GetRangeReader", (function(r, a) {
                        ...
                        o ? (a.onPull = function() {
                            o.read().then((function(t) {
                                ...
                                t.done ? a.close() : ((0,
                                _util.assert)((0,
                                _util.isArrayBuffer)(r), "GetRangeReader - expected an ArrayBuffer."),
                                a.enqueue(new Uint8Array(r), 1, [r]))
                            }
                            )).catch((function(t) {
                                a.error(t)
                    ...
                    r.on("PasswordRequest", (function(r) {
                        ...
                        a.onPassword) {
                            ...
                            t._passwordCapability.reject(new _util.PasswordException(r.message,r.code));
                            ...
                            if (!t.commonObjs.has(i))
                                ...
                                case "Font":
                                    ...
                                    if ("error"in u) {
                                        var d = u.error;
                                        (0,
                                        _util.warn)("Error during font loading: ".concat(d)),
                    ...
                    r.on("FetchBuiltInCMap", (function(r, a) {
                        if (t.destroyed)
                            ...
                            a.onPull = function() {
                                o ? a.close() : (o = !0,
                                t.CMapReaderFactory.fetch(r).then((function(t) {
                ...
                value: function getPage(t) {
                    ...
                    var o = this.messageHandler.sendWithPromise("GetPage", {
                        ...
                        return r.pageCache[a] = o,
                        o
                    }
                    ));
                    return this.pagePromises[a] = o,
                    o
                }
            }, {
                key: "getPageIndex",
                ...
                value: function startCleanup() {
                    ...
                    return this.messageHandler.sendWithPromise("Cleanup", null).then((function() {
                        for (var r = 0, a = t.pageCache.length; r < a; r++) {
                            ...
                            if (o)
                                if (!o.cleanup())
                                    throw new Error("startCleanup: Page ".concat(r + 1, " is currently rendering."))
                        }
                        t.commonObjs.clear(),
                        t.fontLoader.clear()
                    }
          ...
          , PDFObjects = function() {
            ...
            return _createClass(PDFObjects, [{
                ...
                value: function get(t) {
                    ...
                    if (r)
                        return this._ensureObj(t).capability.promise.then(r),
                        null;
                    var a = this._objs[t];
                    if (!a || !a.resolved)
                ...
                return _createClass(InternalRenderTask, [{
                    ...
                    value: function initializeGraphics() {
                        ...
                        if (!this.cancelled) {
                            ...
                            this._pdfBug && globalThis.StepperManager && globalThis.StepperManager.enabled && (this.stepper = globalThis.StepperManager.create(this._pageIndex),
                            ...
                            var a = this.params
                              ...
                              , u = a.imageLayer
                              , c = a.background;
                            this.gfx = new _canvas.CanvasGraphics(o,this.commonObjs,this.objs,this.canvasFactory,this.webGLContext,u),
                    ...
                    value: function cancel() {
                        ...
                        this.callback(r || new _display_utils.RenderingCancelledException("Rendering cancelled, page ".concat(this._pageIndex + 1),"canvas"))
                    }
                }, {
    ...
    , function(t, r, a) {
        ...
        var l, u = function() {
            function BaseFontLoader(t) {
                ...
                i.unreachable)("Cannot initialize BaseFontLoader."),
                this.docId = r,
            ...
            return _createClass(BaseFontLoader, [{
                ...
                value: function insertRule(t) {
                    ...
                    r || ((r = this.styleElement = document.createElement("style")).id = "PDFJS_FONT_STYLE_TAG_".concat(this.docId),
                    ...
                    return o.default.wrap((function _callee$(o) {
                        for (; ; )
                            ...
                            case 2:
                                ...
                                return this.addNativeFontFace(r),
                                o.prev = 7,
                                o.next = 10,
                                r.loaded;
                            case 10:
                            ...
                            case 12:
                                ...
                                (0,
                                i.warn)("Failed to load font '".concat(r.family, "': '").concat(o.t0, "'.")),
                                t.disableFontFace = !0,
                                o.t0;
                            case 18:
                                return o.abrupt("return");
                ...
                value: function _queueLoadingCallback(t) {
                    (0,
                    i.unreachable)("Abstract method `_queueLoadingCallback`.")
                }
            }, {
                key: "_prepareFontLoadEvent",
                value: function _prepareFontLoadEvent(t, r, a) {
                    (0,
                    i.unreachable)("Abstract method `_prepareFontLoadEvent`.")
                }
            }, {
                ...
                get: function get() {
                    (0,
                    i.unreachable)("Abstract method `isSyncFontLoadingSupported`.")
                }
            }, {
                key: "_loadTestFont",
                get: function get() {
                    (0,
                    i.unreachable)("Abstract method `_loadTestFont`.")
                }
            }]),
            BaseFontLoader
        }();
        r.FontLoader = l,
        r.FontLoader = l = function(t) {
            !function _inherits(t, r) {
                if ("function" != typeof r && null !== r)
                    throw new TypeError("Super expression must either be null or a function");
                t.prototype = Object.create(r && r.prototype, {
            ...
            function GenericFontLoader(t) {
                var a;
                return _classCallCheck(this, GenericFontLoader),
                (a = r.call(this, t)).loadingContext = {
                    requests: [],
                    nextRequestId: 0
                },
                a.loadTestFontId = 0,
            ...
            return _createClass(GenericFontLoader, [{
                    ...
                    var r = this.loadingContext
                      , a = {
                        ...
                        complete: function completeRequest() {
                            for ((0,
                            i.assert)(!a.done, "completeRequest() cannot be called twice."),
                            a.done = !0; r.requests.length > 0 && r.requests[0].done; ) {
                ...
                value: function _prepareFontLoadEvent(t, r, a) {
                    ...
                    for (o = 0,
                    l = r.length; o < l; o++)
                        b.push(r[o].loadedName);
                    b.push(h);
                    var _ = document.createElement("div");
                    for (_.style.visibility = "hidden",
                    ...
                    function isFontReady(t, r) {
                        ...
                        c.font = "30px " + t,
                        c.fillText(".", 0, 20),
                        c.getImageData(0, 0, 1, 1).data[3] > 0 ? r() : setTimeout(isFontReady.bind(null, t, r))
                    }(h, (function() {
                ...
                get: function get() {
                    return (0,
                    i.shadow)(this, "_loadTestFont", function getLoadTestFont() {
            ...
            return _createClass(FontFaceObject, [{
                ...
                value: function createFontFaceRule() {
                    if (!this.data || this.disableFontFace)
                        return null;
                    var t = (0,
                    i.bytesToString)(new Uint8Array(this.data))
                ...
                value: function getPathGenerator(t, r) {
                    if (void 0 !== this.compiledGlyphs[r])
                    ...
                    try {
                        ...
                        (0,
                        i.warn)('getPathGenerator - ignoring character: "'.concat(t, '".')),
                    ...
                    return this.compiledGlyphs[r] = function(t, r) {
                        for (var i = 0, l = a.length; i < l; i++)
                            "scale" === (o = a[i]).cmd && (o.args = [r, -r]),
                            t[o.cmd].apply(t, o.args)
                    }
                }
            }]),
            FontFaceObject
    ...
    , function(t, r, a) {
        ...
        function addContextCurrentTransform(t) {
            ...
            t.transform = function ctxTransform(r, a, o, i, l, u) {
                ...
                this._transformMatrix = [c[0] * r + c[2] * a, c[1] * r + c[3] * a, c[0] * o + c[2] * i, c[1] * o + c[3] * i, c[0] * l + c[2] * u + c[4], c[1] * l + c[3] * u + c[5]],
                t._originalTransform(r, a, o, i, l, u)
            }
            ,
            t.setTransform = function ctxSetTransform(r, a, o, i, l, u) {
                this._transformMatrix = [r, a, o, i, l, u],
                t._originalSetTransform(r, a, o, i, l, u)
            }
            ,
            t.rotate = function ctxRotate(t) {
                ...
                this._transformMatrix = [o[0] * r + o[2] * a, o[1] * r + o[3] * a, o[0] * -a + o[2] * r, o[1] * -a + o[3] * r, o[4], o[5]],
        ...
        var d = function CachedCanvasesClosure() {
            ...
            return CachedCanvases.prototype = {
                getCanvas: function CachedCanvases_getCanvas(t, r, a, o) {
                    ...
                    i.context.setTransform(1, 0, 0, 1, 0, 0)) : (i = this.canvasFactory.create(r, a),
                    this.cache[t] = i),
        ...
        var h = function CanvasExtraStateClosure() {
          ...
          , p = function CanvasGraphicsClosure() {
            ...
            function putBinaryImageData(t, r) {
                if ("undefined" != typeof ImageData && r instanceof ImageData)
                    t.putImageData(r, 0, 0);
                else {
                    var a, i, l, u, d, h = r.height, p = r.width, m = h % c, v = (h - m) / c, g = 0 === m ? v : v + 1, y = t.createImageData(p, c), b = 0, _ = r.data, S = y.data;
                    if (r.kind === o.ImageKind.GRAYSCALE_1BPP) {
                        ...
                        for (i = 0; i < g; i++) {
                            ...
                            a = 0,
                            l = 0; l < u; l++) {
                                for (var x = A - b, T = 0, E = x > k ? p : 8 * x - 7, O = -8 & E, I = 0, D = 0; T < O; T += 8)
                                    D = _[b++],
                                    C[a++] = 128 & D ? P : w,
                                    C[a++] = 64 & D ? P : w,
                                    C[a++] = 32 & D ? P : w,
                        ...
                        d = p * c * 4,
                        i = 0; i < v; i++)
                            S.set(_.subarray(b, b + d)),
                            b += d,
                            t.putImageData(y, 0, l),
                            l += c;
                        i < g && (d = p * m * 4,
                        S.set(_.subarray(b, b + d)),
                        t.putImageData(y, 0, l))
            ...
            function copyCtxState(t, r) {
                ...
                void 0 !== t.setLineDash && (r.setLineDash(t.getLineDash()),
                r.lineDashOffset = t.lineDashOffset)
            }
            ...
            function composeSMask(t, r, a, o) {
                ...
                if (!r.transferMap && o.isEnabled) {
                    ...
                    void t.drawImage(c, r.offsetX, r.offsetY)
                }
                !function genericComposeSMask(t, r, a, o, i, l, u) {
                    var c, d = !!l, h = d ? l[0] : 0, p = d ? l[1] : 0, m = d ? l[2] : 0;
            ...
            for (var m in CanvasGraphics.prototype = {
                ...
                executeOperatorList: function CanvasGraphics_executeOperatorList(t, r, a, i) {
                    ...
                    for (var h, p = d - c > 10 && "function" == typeof a, m = p ? Date.now() + 15 : 0, v = 0, g = this.commonObjs, y = this.objs; ; ) {
                        if (void 0 !== i && c === i.nextBreakPoint)
                            return i.breakIt(c, a),
                            c;
                        if ((h = u[c]) !== o.OPS.dependency)
                            this[h].apply(this, l[c]);
                        else {
                ...
                setDash: function CanvasGraphics_setDash(t, r) {
                    var a = this.ctx;
                    void 0 !== a.setLineDash && (a.setLineDash(t),
                    a.lineDashOffset = r)
                },
                ...
                transform: function CanvasGraphics_transform(t, r, a, o, i, l) {
                    this.ctx.transform(t, r, a, o, i, l),
                    this._cachedGetSinglePixelWidth = null
                },
                constructPath: function CanvasGraphics_constructPath(t, r) {
                    for (var a = this.ctx, i = this.current, l = i.x, u = i.y, c = 0, d = 0, h = t.length; c < h; c++)
                        switch (0 | t[c]) {
                ...
                stroke: function CanvasGraphics_stroke(t) {
                    ...
                    if (r.globalAlpha = this.current.strokeAlpha,
                    a && a.hasOwnProperty("type") && "Pattern" === a.type) {
                        ...
                        r.lineWidth = Math.max(this.getSinglePixelWidth() * u, this.current.lineWidth * l),
                        r.stroke(),
                        r.restore()
                    } else
                ...
                fill: function CanvasGraphics_fill(t) {
                    ...
                    var r = this.ctx
                      ...
                      , o = !1;
                    this.current.patternFill && (r.save(),
                    this.baseTransform && r.setTransform.apply(r, this.baseTransform),
                    r.fillStyle = a.getPattern(r, this),
                    o = !0),
                    this.pendingEOFill ? (r.fill("evenodd"),
                    this.pendingEOFill = !1) : r.fill(),
                    o && r.restore(),
                    t && this.consumePath()
                },
                ...
                setFont: function CanvasGraphics_setFont(t, r) {
                    ...
                    if (i.fontMatrix = a.fontMatrix ? a.fontMatrix : o.FONT_IDENTITY_MATRIX,
                    0 !== i.fontMatrix[0] && 0 !== i.fontMatrix[3] || (0,
                    o.warn)("Invalid font matrix for font " + t),
                    r < 0 ? (r = -r,
                ...
                paintChar: function paintChar(t, r, a, i) {
                    var l, u = this.ctx, c = this.current, d = c.font, h = c.textRenderingMode, p = c.fontSize / c.fontSizeScale, m = h & o.TextRenderingMode.FILL_STROKE_MASK, v = !!(h & o.TextRenderingMode.ADD_TO_PATH_FLAG), g = c.patternFill && !d.missingFile;
                    ((d.disableFontFace || v || g) && (l = d.getPathGenerator(this.commonObjs, t)),
                    d.disableFontFace || g ? (u.save(),
                    u.translate(r, a),
                    u.beginPath(),
                    l(u, p),
                    i && u.setTransform.apply(u, i),
                    m !== o.TextRenderingMode.FILL && m !== o.TextRenderingMode.FILL_STROKE || u.fill(),
                    m !== o.TextRenderingMode.STROKE && m !== o.TextRenderingMode.FILL_STROKE || u.stroke(),
                    u.restore()) : (m !== o.TextRenderingMode.FILL && m !== o.TextRenderingMode.FILL_STROKE || u.fillText(t, r, a),
                    m !== o.TextRenderingMode.STROKE && m !== o.TextRenderingMode.FILL_STROKE || u.strokeText(t, r, a)),
                    v) && (this.pendingTextPaths || (this.pendingTextPaths = [])).push({
                ...
                get isFontSubpixelAAEnabled() {
                    ...
                    return (0,
                    o.shadow)(this, "isFontSubpixelAAEnabled", a)
                },
                showText: function CanvasGraphics_showText(t) {
                    ...
                    var i = r.fontSize;
                    if (0 !== i) {
                        var l, c = this.ctx, d = r.fontSizeScale, h = r.charSpacing, p = r.wordSpacing, m = r.fontDirection, v = r.textHScale * m, g = t.length, y = a.vertical, b = y ? 1 : -1, _ = a.defaultVMetrics, S = i * r.fontMatrix[0], A = r.textRenderingMode === o.TextRenderingMode.FILL && !a.disableFontFace && !r.patternFill;
                        if (c.save(),
                        r.patternFill) {
                            c.save();
                            var C = r.fillColor.getPattern(c, this);
                            l = c.mozCurrentTransform,
                            c.restore(),
                            c.fillStyle = C
                        }
                        ...
                        if (0 === k || 0 === R) {
                            ...
                            P !== o.TextRenderingMode.STROKE && P !== o.TextRenderingMode.FILL_STROKE || (this._cachedGetSinglePixelWidth = null,
                        ...
                        for (w = 0; w < g; ++w) {
                            ...
                            o.isNum)(T))
                                ...
                                var E, O, I, D, L, W, M, j = !1, N = (T.isSpace ? p : 0) + h, B = T.fontChar, q = T.accent, G = T.width;
                                if (y)
                                    L = T.vmetric || _,
                                    W = -(W = T.vmetric ? L[1] : .5 * G) * S,
                                    M = L[2] * S,
                                    G = L ? -L[0] : G,
                                    E = W / d,
                                    O = (x + M) / d;
                                ...
                                (T.isInFont || a.missingFile) && (A && !q ? c.fillText(B, E, O) : (this.paintChar(B, E, O, l),
                                q && (I = E + q.offset.x / d,
                                D = O - q.offset.y / d,
                ...
                showType3Text: function CanvasGraphics_showType3Text(t) {
                    var r, a, i, l, u = this.ctx, c = this.current, d = c.font, h = c.fontSize, p = c.fontDirection, m = d.vertical ? 1 : -1, v = c.charSpacing, g = c.wordSpacing, y = c.textHScale * p, b = c.fontMatrix || o.FONT_IDENTITY_MATRIX, _ = t.length;
                    if (!(c.textRenderingMode === o.TextRenderingMode.INVISIBLE) && 0 !== h) {
                        for (this._cachedGetSinglePixelWidth = null,
                        u.save(),
                        ...
                        r = 0; r < _; ++r)
                            ...
                            o.isNum)(a))
                                ...
                                if (A)
                                    ...
                                    (0,
                                    o.warn)('Type3 character "'.concat(a.operatorListId, '" is not available.'))
                            }
                        u.restore(),
                        this.processingType3 = null
                    }
                ...
                beginGroup: function CanvasGraphics_beginGroup(t) {
                    ...
                    if (t.matrix && r.transform.apply(r, t.matrix),
                    !t.bbox)
                ...
                paintImageMaskXObject: function CanvasGraphics_paintImageMaskXObject(t) {
                    ...
                    if (u && void 0 === u.compiled && (u.compiled = a <= 1e3 && o <= 1e3 ? function compileType3Glyph(t) {
                        var r, a, o, i, l = t.width, u = t.height, c = l + 1, d = new Uint8Array(c * (u + 1)), h = new Uint8Array([0, 2, 4, 0, 1, 0, 5, 4, 8, 10, 0, 8, 0, 2, 1, 0]), p = l + 7 & -8, m = t.data, v = new Uint8Array(p * u), g = 0;
                        for (r = 0,
                        i = m.length; r < i; r++)
                        ...
                        r = 1; r < u; r++) {
                            o = r * c,
                            v[(g = r * p) - p] !== v[g] && (d[o] = v[g] ? 1 : 8,
                            ++_);
                            var S = (v[g] ? 4 : 0) + (v[g - p] ? 8 : 0);
                            for (a = 1; a < l; a++)
                                h[S = (S >> 2) + (v[g + 1] ? 4 : 0) + (v[g - p + 1] ? 8 : 0)] && (d[o + a] = h[S],
                                ++_),
                                g++;
                            if (v[g - p] !== v[g] && (d[o + a] = v[g] ? 2 : 4,
                            ++_),
                            _ > 1e3)
                                return null
                        }
                        ...
                        var A = new Int32Array([0, c, -1, 0, -c, 0, 0, 0, 1])
                          , C = [];
                        for (r = 0; _ && r <= u; r++) {
                            for (var R = r * c, k = R + l; R < k && !d[R]; )
                                R++;
                            if (R !== k) {
                                var P, w = [R % c, r], x = d[R], T = R;
                                do {
                                    var E = A[x];
                                    do {
                                        R += E
                ...
                paintImageXObject: function CanvasGraphics_paintImageXObject(t) {
                    ...
                    r ? this.paintInlineImageXObject(r) : (0,
                ...
                paintInlineImageXObject: function CanvasGraphics_paintInlineImageXObject(t) {
                    ...
                    this.save(),
                    o.scale(1 / r, -1 / a);
                    var i, l, u = o.mozCurrentTransformInverse, c = u[0], d = u[1], h = Math.max(Math.sqrt(c * c + d * d), 1), p = u[2], m = u[3], v = Math.max(Math.sqrt(p * p + m * m), 1);
                    ...
                    if (o.drawImage(i, 0, 0, y, b, 0, -a, r, a),
                    this.imageLayer) {
                ...
                paintXObject: function CanvasGraphics_paintXObject() {
                    (0,
                    o.warn)("Unsupported 'paintXObject' command.")
                },
                ...
                consumePath: function CanvasGraphics_consumePath() {
                    var t = this.ctx;
                    this.pendingClip && (this.pendingClip === p ? t.clip("evenodd") : t.clip(),
                    this.pendingClip = null),
                    t.beginPath()
                },
    ...
    , function(t, r, a) {
            ...
            fromIR: function RadialAxial_fromIR(t) {
                ...
                return {
                    ...
                    getPattern: function RadialAxial_getPattern(t) {
                        ...
                        "axial" === r ? d = t.createLinearGradient(i[0], i[1], l[0], l[1]) : "radial" === r && (d = t.createRadialGradient(i[0], i[1], u, l[0], l[1], c));
        ...
        var l = function createMeshCanvasClosure() {
            function drawTriangle(t, r, a, o, i, l, u, c) {
                var d, h = r.coords, p = r.colors, m = t.data, v = 4 * t.width;
                h[a + 1] > h[o + 1] && (d = a,
                a = o,
                o = d,
                d = l,
                ...
                if (!(y >= A))
                    for (var C, R, k, P, w, x, T, E, O = p[l], I = p[l + 1], D = p[l + 2], L = p[u], W = p[u + 1], M = p[u + 2], j = p[c], N = p[c + 1], B = p[c + 2], q = Math.round(y), G = Math.round(A), U = q; U <= G; U++) {
                        ...
                        T = I - (I - N) * Y,
                        E = D - (D - B) * Y;
                        for (var X = Math.round(Math.min(C, w)), V = Math.round(Math.max(C, w)), Q = v * U + 4 * X, K = X; K <= V; K++)
            ...
            function drawFigure(t, r, a) {
                ...
                case "lattice":
                    var c = r.verticesPerRow
                      ...
                      , h = c - 1;
                    for (o = 0; o < d; o++)
                        for (var p = o * c, m = 0; m < h; m++,
                        p++)
                            drawTriangle(t, a, l[p], l[p + 1], l[p + c], u[p], u[p + 1], u[p + c]),
                            drawTriangle(t, a, l[p + c + 1], l[p + 1], l[p + c], u[p + c + 1], u[p + 1], u[p + c]);
                    break;
                case "triangles":
                    for (o = 0,
                    i = l.length; o < i; o += 3)
            ...
            return function createMeshCanvas(t, r, a, o, i, l, u, c) {
                var d, h, p, m, v = Math.floor(t[0]), g = Math.floor(t[1]), y = Math.ceil(t[2]) - v, b = Math.ceil(t[3]) - g, _ = Math.min(Math.ceil(Math.abs(y * r[0] * 1.1)), 3e3), S = Math.min(Math.ceil(Math.abs(b * r[1] * 1.1)), 3e3), A = y / _, C = b / S, R = {
                    coords: a,
                    colors: o,
                    offsetX: -v,
                    offsetY: -g,
        ...
        var u = function TilingPatternClosure() {
            ...
            return TilingPattern.prototype = {
                createPatternCanvas: function TilinPattern_createPatternCanvas(t) {
                    ...
                    return k.groupLevel = t.groupLevel,
                ...
                getPattern: function TilingPattern_getPattern(t, r) {
                    (t = this.ctx).setTransform.apply(t, this.baseTransform),
            ...
            function MessageHandler(t, r, a) {
                ...
                this._onComObjOnMessage = function(t) {
                    ...
                    if (r.targetName === o.sourceName)
                        if (r.stream)
                            o._processStreamMessage(r);
                        else if (r.callback) {
                            var i = r.callbackId
                              , c = o.callbackCapabilities[i];
                            if (!c)
                                throw new Error("Cannot resolve callback ".concat(i));
                            if (delete o.callbackCapabilities[i],
                            r.callback === l)
                                c.resolve(r.data);
                            else {
                                if (r.callback !== u)
                            ...
                            if (!d)
                                throw new Error("Unknown action from worker: ".concat(r.action));
                            if (r.callbackId) {
                                var h = o.sourceName
                                  , p = r.sourceName;
                                ...
                                r.streamId ? o._createStreamSink(r) : d(r.data)
                        }
                }
                ,
            ...
            return function _createClass(t, r, a) {
                ...
                value: function sendWithStream(t, r, a, o) {
                    ...
                    return new ReadableStream({
                        ...
                        pull: function pull(t) {
                            var r = (0,
                            i.createPromiseCapability)();
                            return l.streamControllers[u].pullCall = r,
                            p.postMessage({
                                sourceName: d,
                                targetName: h,
                                stream: v,
                        ...
                        cancel: function cancel(t) {
                            ...
                            var r = (0,
                            i.createPromiseCapability)();
                            return l.streamControllers[u].cancelCall = r,
                      ...
                      , d = {
                        enqueue: function enqueue(t) {
                            ...
                            if (!this.isCancelled) {
                                ...
                                this.desiredSize -= a,
                                d > 0 && this.desiredSize <= 0 && (this.sinkCapability = (0,
                                i.createPromiseCapability)(),
                ...
                value: function _processStreamMessage(t) {
                    ...
                    case v:
                        ...
                        this.streamSinks[r].desiredSize <= 0 && t.desiredSize > 0 && this.streamSinks[r].sinkCapability.resolve(),
                    ...
                    case p:
                        if ((0,
                        i.assert)(this.streamControllers[r], "enqueue should have stream controller"),
                    ...
                    case h:
                        if ((0,
                        i.assert)(this.streamControllers[r], "close should have stream controller"),
                        this.streamControllers[r].isClosed)
                            break;
                    ...
                    case m:
                        (0,
                        i.assert)(this.streamControllers[r], "error should have stream controller"),
                        this.streamControllers[r].controller.error(wrapReason(t.reason)),
                        this._deleteStreamController(r);
                        break;
                    case d:
                        t.success ? this.streamControllers[r].cancelCall.resolve() : this.streamControllers[r].cancelCall.reject(wrapReason(t.reason)),
                        this._deleteStreamController(r);
                        break;
                    case c:
                        if (!this.streamSinks[r])
                ...
                value: (t = function _asyncToGenerator(t) {
                    ...
                    return o.default.wrap((function _callee$(r) {
                        for (; ; )
                            ...
                            case 0:
                                return r.next = 2,
                                Promise.allSettled([this.streamControllers[t].startCall, this.streamControllers[t].pullCall, this.streamControllers[t].cancelCall].map((function(t) {
                                    return t && t.promise
                                }
                                )));
                            case 2:
    ...
    , function(t, r, a) {
        ...
        var l = function() {
            function Metadata(t) {
                ...
                (0,
                o.assert)("string" == typeof t, "Metadata: input is not a string"),
                t = this._repair(t);
            ...
            return function _createClass(t, r, a) {
                ...
                value: function getAll() {
                    var t, r = Object.create(null), a = function _createForOfIteratorHelper(t, r) {
                        var a;
                        if ("undefined" == typeof Symbol || null == t[Symbol.iterator]) {
                            if (Array.isArray(t) || (a = _unsupportedIterableToArray(t)) || r && t && "number" == typeof t.length) {
                                a && (t = a);
        ...
        var p = function() {
            ...
            return _createClass(XMLParserBase, [{
                ...
                value: function _parseContent(t, r) {
                    var a = []
                      , o = r;
                    function skipWs() {
                        for (; o < t.length && isWhitespace(t, o); )
                            ++o
                    }
                    for (; o < t.length && !isWhitespace(t, o) && ">" !== t[o] && "/" !== t[o]; )
                        ++o;
                ...
                value: function _parseProcessingInstruction(t, r) {
                    var a = r;
                    for (; a < t.length && !isWhitespace(t, a) && ">" !== t[a] && "/" !== t[a]; )
                        ++a;
                    var o = t.substring(r, a);
                    !function skipWs() {
                        for (; a < t.length && isWhitespace(t, a); )
                            ++a
                    }();
                    for (var i = a; a < t.length && ("?" !== t[a] || ">" !== t[a + 1]); )
                        ++a;
                    return {
                        name: o,
                        ...
                        if ("<" === t[r]) {
                            ...
                            default:
                                ...
                                if (null === y)
                                    return void this.onError(d);
                                var b = !1;
                                if ("/>" === t.substring(a + y.parsed, a + y.parsed + 2))
                                    b = !0;
          ...
          , v = function(t) {
            ...
            function SimpleXMLParser() {
                var t;
                return _classCallCheck(this, SimpleXMLParser),
            ...
            return _createClass(SimpleXMLParser, [{
                ...
                value: function onBeginElement(t, r, a) {
                    ...
                    a || (this._stack.push(this._currentFragment),
    ...
    , function(t, r, a) {
        ...
        var l = function() {
            function PDFDataTransportStream(t, r) {
                ...
                (0,
                i.assert)(r, 'PDFDataTransportStream - missing required "pdfDataRangeTransport" argument.'),
                this._queuedChunks = [],
            ...
            return _createClass(PDFDataTransportStream, [{
                ...
                value: function _onReceiveData(t) {
                    ...
                    if (void 0 === t.begin)
                        ...
                        var a = this._rangeReaders.some((function(a) {
                            return a._begin === t.begin && (a._enqueue(r),
                            !0)
                        }
                        ));
                        (0,
                        i.assert)(a, "_onReceiveData - no `PDFDataTransportStreamRangeReader` instance found.")
                    }
                }
            }, {
                key: "_onProgress",
                ...
                value: function getFullReader() {
                    ...
                    new u(this,t,this._progressiveDone)
                }
            }, {
                key: "getRangeReader",
                value: function getRangeReader(t, r) {
                    ...
                    return this._pdfDataRangeTransport.requestDataRange(t, r),
                    this._rangeReaders.push(a),
                    a
                }
            }, {
                    ...
                    return o.default.wrap((function _callee$(a) {
                        for (; ; )
                            ...
                            case 0:
                                ...
                                return t = this._queuedChunks.shift(),
                                a.abrupt("return", {
                                    value: t,
                                    done: !1
                                });
    ...
    , function(t, r, a) {
        ...
        var i = function() {
            ...
            return function _createClass(t, r, a) {
                ...
                get: function get() {
                    var t = this._enabled;
                    return t && (t = l.tryInitGL()),
                    (0,
                    o.shadow)(this, "isEnabled", t)
                }
            }]),
            WebGLContext
        }();
        ...
        var l = function WebGLUtilsClosure() {
            ...
            function createProgram(t, r) {
                for (var a = t.createProgram(), o = 0, i = r.length; o < i; ++o)
                    t.attachShader(a, r[o]);
                if (t.linkProgram(a),
            ...
            var t, r;
            function generateGL() {
                t || (r = document.createElement("canvas"),
            ...
            return {
                ...
                composeSMask: function composeSMask(o, i, l) {
                    ...
                    l.backdrop ? p.uniform4f(d.resolutionLocation, l.backdrop[0], l.backdrop[1], l.backdrop[2], 1) : p.uniform4f(d.resolutionLocation, 0, 0, 0, 0),
                    p.uniform1i(d.subtypeLocation, "Luminosity" === l.subtype ? 1 : 0);
                    var m = createTexture(p, o, p.TEXTURE0)
                      , v = createTexture(p, i, p.TEXTURE1)
                      , g = p.createBuffer();
                    return p.bindBuffer(p.ARRAY_BUFFER, g),
                    p.bufferData(p.ARRAY_BUFFER, new Float32Array([0, 0, u, 0, 0, c, 0, c, u, 0, u, c]), p.STATIC_DRAW),
                ...
                drawFigures: function drawFigures(a, i, l, u, c) {
                    ...
                    return p.bindBuffer(p.ARRAY_BUFFER, W),
        ...
        var l = function() {
          ...
          , u = function() {
            ...
            return _createClass(AnnotationElement, [{
                ...
                value: function _createContainer() {
                    ...
                    if (l.style.transform = "matrix(".concat(o.transform.join(","), ")"),
                    ...
                    !t && r.borderStyle.width > 0) {
                        ...
                        r.borderStyle.style !== i.AnnotationBorderStyleType.UNDERLINE && (u -= 2 * r.borderStyle.width,
                    ...
                    return l.style.left = "".concat(d[0], "px"),
                ...
                value: function _createPopup(t, r, a) {
                    r || ((r = document.createElement("div")).style.height = t.style.height,
          ...
          , c = function(t) {
            ...
            return _createClass(LinkAnnotationElement, [{
                ...
                value: function _bindLink(t, r) {
                    ...
                    t.onclick = function() {
                        return r && a.linkService.navigateTo(r),
                        !1
                    }
                    ,
                ...
                value: function _bindNamedAction(t, r) {
                    ...
                    t.onclick = function() {
                        return a.linkService.executeNamedAction(r),
                        !1
                    }
                    ,
          ...
          , h = function(t) {
            ...
            function WidgetAnnotationElement() {
                return _classCallCheck(this, WidgetAnnotationElement),
                r.apply(this, arguments)
            }
            ...
            return _createClass(TextWidgetAnnotationElement, [{
                ...
                value: function render() {
                    ...
                    if (this.renderInteractiveForms) {
                        ...
                        var a = null;
                        this.data.fontRefName && this.page.commonObjs.has(this.data.fontRefName) && (a = this.page.commonObjs.get(this.data.fontRefName)),
                        this._setTextStyle(t, a)
                    }
                    return null !== this.data.textAlignment && (t.style.textAlign = ["left", "center", "right"][this.data.textAlignment]),
                    this.container.appendChild(t),
                    this.container
                }
            }, {
                ...
                value: function _setTextStyle(t, r) {
                    var a = t.style;
                    if (a.fontSize = "".concat(this.data.fontSize, "px"),
          ...
          , m = function(t) {
            ...
            function CheckboxWidgetAnnotationElement(t) {
                return _classCallCheck(this, CheckboxWidgetAnnotationElement),
          ...
          , v = function(t) {
            ...
            function RadioButtonWidgetAnnotationElement(t) {
                return _classCallCheck(this, RadioButtonWidgetAnnotationElement),
                r.call(this, t, t.renderInteractiveForms)
            }
          ...
          , g = function(t) {
            ...
            function PushButtonWidgetAnnotationElement() {
                return _classCallCheck(this, PushButtonWidgetAnnotationElement),
                r.apply(this, arguments)
            }
            return _createClass(PushButtonWidgetAnnotationElement, [{
                ...
                value: function render() {
                    ...
                    return t.className = "buttonWidgetAnnotation pushButton",
                    t
                }
            }]),
          ...
          , y = function(t) {
            ...
            function ChoiceWidgetAnnotationElement(t) {
                return _classCallCheck(this, ChoiceWidgetAnnotationElement),
                r.call(this, t, t.renderInteractiveForms)
            }
          ...
          , b = function(t) {
            ...
            return _createClass(PopupAnnotationElement, [{
                ...
                value: function render() {
                    ...
                    return this.container.style.transformOrigin = "-".concat(o + i, "px -").concat(r.style.top),
          ...
          , S = function(t) {
            ...
            return _createClass(FreeTextAnnotationElement, [{
                key: "render",
                value: function render() {
                    return this.container.className = "freeTextAnnotation",
          ...
          , A = function(t) {
            ...
            return _createClass(LineAnnotationElement, [{
                ...
                value: function render() {
                    ...
                    return i.setAttribute("x1", t.rect[2] - t.lineCoordinates[0]),
          ...
          , k = function(t) {
            ...
            function PolylineAnnotationElement(t) {
                ...
                return (a = r.call(this, t, o, !0)).containerClassName = "polylineAnnotation",
            ...
            return _createClass(PolylineAnnotationElement, [{
                ...
                value: function render() {
                    ...
                    var t, r = this.data, a = r.rect[2] - r.rect[0], o = r.rect[3] - r.rect[1], i = this.svgFactory.create(a, o), l = [], u = _createForOfIteratorHelper(r.vertices);
                    try {
                        for (u.s(); !(t = u.n()).done; ) {
                            var c = t.value
                              , d = c.x - r.rect[0]
                    ...
                    return p.setAttribute("points", l),
          ...
          , P = function(t) {
            ...
            function PolygonAnnotationElement(t) {
                var a;
                return _classCallCheck(this, PolygonAnnotationElement),
          ...
          , x = function(t) {
            ...
            function InkAnnotationElement(t) {
                ...
                var o = !!(t.data.hasPopup || t.data.title || t.data.contents);
                return (a = r.call(this, t, o, !0)).containerClassName = "inkAnnotation",
                a.svgElementName = "svg:polyline",
                a
            }
            return _createClass(InkAnnotationElement, [{
                ...
                value: function render() {
                    this.container.className = this.containerClassName;
                    var t, r = this.data, a = r.rect[2] - r.rect[0], o = r.rect[3] - r.rect[1], i = this.svgFactory.create(a, o), l = _createForOfIteratorHelper(r.inkLists);
                    try {
                        for (l.s(); !(t = l.n()).done; ) {
                            var u, c = t.value, d = [], h = _createForOfIteratorHelper(c);
                            try {
                                for (h.s(); !(u = h.n()).done; ) {
                                    var p = u.value
                                      , m = p.x - r.rect[0]
          ...
          , L = function(t) {
            ...
            return _createClass(FileAttachmentAnnotationElement, [{
                ...
                value: function _download() {
                    ...
                    i.warn)("Download cannot be started due to unavailable download manager")
                }
            }]),
          ...
          , W = function() {
            ...
            return _createClass(AnnotationLayer, null, [{
                key: "render",
                value: function render(t) {
                    var r, a = [], u = [], c = _createForOfIteratorHelper(t.annotations);
                    try {
                        for (c.s(); !(r = c.n()).done; ) {
                            var d = r.value;
        ...
        var o = a(5)
          , i = function renderTextLayerClosure() {
            ...
            function appendText(r, a, i) {
                ...
                if (y && (h.vertical ? u.canvasWidth = a.height * r._viewport.scale : u.canvasWidth = a.width * r._viewport.scale),
                ...
                r._enhanceTextSelection) {
                    ...
                    0 !== d && (S = Math.cos(d),
                    A = Math.sin(d));
                    var C, R, k = (h.vertical ? a.height : a.width) * r._viewport.scale, P = v;
                    0 !== d ? (C = [S, A, -A, S, p, m],
                    R = o.Util.getAxialAlignedBoundingBox([0, 0, k, P], C)) : R = [p, m, p + k, m + P],
                    r._bounds.push({
                        left: R[0],
                        top: R[1],
                        right: R[2],
            ...
            function expandBoundsLTR(t, r) {
                ...
                r.forEach((function(t) {
                    for (var r = 0; r < a.length && a[r].end <= t.y1; )
                        r++;
                    for (var o, i, l = a.length - 1; l >= 0 && a[l].start >= t.y2; )
                        l--;
                    var u, c, d = -1 / 0;
                    for (u = r; u <= l; u++) {
                        var h;
                    ...
                    for (t.x1New = d,
                    u = r; u <= l; u++)
                        void 0 === (i = (o = a[u]).boundary).x2New ? i.x2 > t.x1 ? i.index > t.index && (i.x2New = i.x2) : i.x2New = d : i.x2New > d && (i.x2New = Math.max(d, i.x2));
                    var p = []
                      , m = null;
                    for (u = r; u <= l; u++) {
                    ...
                    for (a[r].start < t.y1 && (p[0].start = t.y1,
                    p.unshift({
                        start: a[r].start,
                        end: t.y1,
                        boundary: a[r].boundary
                    })),
                    t.y2 < a[l].end && (p[p.length - 1].end = t.y2,
                    p.push({
                        start: t.y2,
                        end: a[l].end,
                    ...
                    u = r; u <= l; u++)
                        if (void 0 === (i = (o = a[u]).boundary).x2New) {
                            var g = !1;
                            for (c = r - 1; !g && c >= 0 && a[c].start >= i.y1; c--)
                                g = a[c].boundary === i;
                            for (c = l + 1; !g && c < a.length && a[c].end <= i.y2; c++)
                                g = a[c].boundary === i;
                            for (c = 0; !g && c < p.length; c++)
                                g = p[c].boundary === i;
                            g || (i.x2New = d)
                        }
            ...
            function TextLayerRenderTask(t) {
                ...
                this._capability.promise.finally((function() {
                    r._layoutTextCtx && (r._layoutTextCtx.canvas.width = 0,
            ...
            return TextLayerRenderTask.prototype = {
                ...
                cancel: function TextLayer_cancel() {
                    this._canceled = !0,
                    this._reader && (this._reader.cancel(new o.AbortException("TextLayer task cancelled.")),
                    this._reader = null),
                ...
                _processItems: function _processItems(t, r) {
                    for (var a = 0, o = t.length; a < o; a++)
                        this._textContentItemsStr.push(t[a].str),
                        appendText(this, t[a], r)
                },
                    ...
                    if (!r.isWhitespace) {
                        ...
                        if (0 !== r.canvasWidth) {
                            var o = t.style
                              , i = o.fontSize
                              , l = o.fontFamily;
                            i === this._layoutTextLastFontSize && l === this._layoutTextLastFontFamily || (this._layoutTextCtx.font = "".concat(i, " ").concat(l),
                            this._layoutTextLastFontSize = i,
                            this._layoutTextLastFontFamily = l);
                            var u = this._layoutTextCtx.measureText(t.textContent).width;
                            u > 0 && (r.scale = r.canvasWidth / u,
                            a = "scaleX(".concat(r.scale, ")"))
                        }
                        0 !== r.angle && (a = "rotate(".concat(r.angle, "deg) ").concat(a)),
                        a.length > 0 && (this._enhanceTextSelection && (r.originalTransform = a),
                        t.style.transform = a),
                ...
                _render: function TextLayer_render(t) {
                    ...
                    if (l.mozOpaque = !0,
                    this._layoutTextCtx = l.getContext("2d", {
                        alpha: !1,
                        willReadFrequently: !0
                    }),
                    this._textContent) {
                        ...
                        function pump() {
                            r._reader.read().then((function(t) {
                                var o = t.value;
                                t.done ? a.resolve() : (Object.assign(i, o.styles),
                                r._processItems(o.items, i),
                                pump())
                            }
                            ), a.reject)
                        }()
                    ...
                    a.promise.then((function() {
                        i = null,
                        t ? r._renderTimer = setTimeout((function() {
                            render(r),
                            r._renderTimer = null
                        }
                        ), t) : render(r)
                ...
                expandTextDivs: function TextLayer_expandTextDivs(t) {
                    if (this._enhanceTextSelection && this._renderingDone) {
                        null !== this._bounds && (expand(this),
                        this._bounds = null);
                        for (var r = [], a = [], o = 0, i = this._textDivs.length; o < i; o++) {
                            var l = this._textDivs[o]
                              , u = this._textDivProperties.get(l);
                            u.isWhitespace || (t ? (r.length = 0,
                            a.length = 0,
                            u.originalTransform && r.push(u.originalTransform),
                            u.paddingTop > 0 ? (a.push("".concat(u.paddingTop, "px")),
                            r.push("translateY(".concat(-u.paddingTop, "px)"))) : a.push(0),
                            u.paddingRight > 0 ? a.push("".concat(u.paddingRight / u.scale, "px")) : a.push(0),
                            u.paddingBottom > 0 ? a.push("".concat(u.paddingBottom, "px")) : a.push(0),
                            u.paddingLeft > 0 ? (a.push("".concat(u.paddingLeft / u.scale, "px")),
                            r.push("translateX(".concat(-u.paddingLeft / u.scale, "px)"))) : a.push(0),
                            l.style.padding = a.join(" "),
                            r.length && (l.style.transform = r.join(" "))) : (l.style.padding = null,
        ...
        var c = function pf(t) {
          ...
          , v = function() {
            ...
            function encode(r, a, i, u) {
                var c, d, h, p = r.width, m = r.height, v = r.data;
                switch (a) {
                ...
                var C = new Uint8Array([p >> 24 & 255, p >> 16 & 255, p >> 8 & 255, 255 & p, m >> 24 & 255, m >> 16 & 255, m >> 8 & 255, 255 & m, c, d, 0, 0, 0])
                  , R = function deflateSync(t) {
                    ...
                    try {
                        ...
                        (0,
                        o.warn)("Not compressing PNG because zlib.deflateSync is unavailable: " + t)
                    }
                    return deflateSyncUncompressed(t)
                }(g)
                ...
                (0,
                o.createObjectURL)(P, "image/png", i)
            }
        ...
        r.SVGGraphics = u = function() {
            ...
            return _createClass(SVGGraphics, [{
                ...
                value: function transform(t, r, a, i, l, u) {
                    var c = [t, r, a, i, l, u];
                    this.transformMatrix = o.Util.transform(this.transformMatrix, c),
                    this.tgrp = null
                }
            }, {
                key: "getSVG",
                value: function getSVG(t, r) {
                    ...
                    return this.loadDependencies(t).then((function() {
                        return a.transformMatrix = o.IDENTITY_MATRIX,
                ...
                value: function convertOpList(t) {
                    ...
                    return function opListToTree(t) {
                        var r, a = [], o = [], i = _createForOfIteratorHelper(t);
                        try {
                            for (i.s(); !(r = i.n()).done; ) {
                                var l = r.value;
                ...
                value: function executeOpTree(t) {
                    ...
                    try {
                        for (a.s(); !(r = a.n()).done; ) {
                            ...
                            default:
                                (0,
                                o.warn)("Unimplemented operator ".concat(l))
                            }
                        }
                    } catch (t) {
                        a.e(t)
                ...
                value: function showText(t) {
                    var r = this.current
                      ...
                      , i = r.fontSize;
                    if (0 !== i) {
                        var l, u = r.fontSizeScale, p = r.charSpacing, m = r.wordSpacing, v = r.fontDirection, g = r.textHScale * v, y = a.vertical, b = y ? 1 : -1, _ = a.defaultVMetrics, S = i * r.fontMatrix[0], A = 0, C = _createForOfIteratorHelper(t);
                        try {
                            for (C.s(); !(l = C.n()).done; ) {
                                var R = l.value;
                                if (null !== R)
                                    ...
                                    o.isNum)(R))
                                        ...
                                        if (y) {
                                            ...
                                            w = A / u,
                                            x = 0;
                                        (R.isInFont || a.missingFile) && (r.xcoords.push(r.x + w),
                        ...
                        y ? r.tspan.setAttributeNS(null, "y", r.ycoords.map(c).join(" ")) : r.tspan.setAttributeNS(null, "y", c(-r.y)),
                        y ? r.y -= A : r.x += A * g,
                        r.tspan.setAttributeNS(null, "font-family", r.fontFamily),
                        r.tspan.setAttributeNS(null, "font-size", "".concat(c(r.fontSize), "px")),
                        r.fontStyle !== h.fontStyle && r.tspan.setAttributeNS(null, "font-style", r.fontStyle),
                        r.fontWeight !== h.fontWeight && r.tspan.setAttributeNS(null, "font-weight", r.fontWeight);
                        var D = r.textRenderingMode & o.TextRenderingMode.FILL_STROKE_MASK;
                        if (D === o.TextRenderingMode.FILL || D === o.TextRenderingMode.FILL_STROKE ? (r.fillColor !== h.fillColor && r.tspan.setAttributeNS(null, "fill", r.fillColor),
                        r.fillAlpha < 1 && r.tspan.setAttributeNS(null, "fill-opacity", r.fillAlpha)) : r.textRenderingMode === o.TextRenderingMode.ADD_TO_PATH ? r.tspan.setAttributeNS(null, "fill", "transparent") : r.tspan.setAttributeNS(null, "fill", "none"),
                        ...
                        r.txtElement.setAttributeNS(null, "transform", "".concat(d(W), " scale(").concat(c(g), ", -1)")),
                        r.txtElement.setAttributeNS("http://www.w3.org/XML/1998/namespace", "xml:space", "preserve"),
                ...
                value: function addFontStyle(t) {
                    ...
                    var r = (0,
                    o.createObjectURL)(t.data, t.mimetype, this.forceDataSchema);
                ...
                value: function setFont(t) {
                    var r = this.current
                      ...
                      , i = t[1];
                    r.font = a,
                    !this.embedFonts || a.missingFile || this.embeddedFonts[a.loadedName] || (this.addFontStyle(a),
                ...
                value: function endText() {
                    var t = this.current;
                    t.textRenderingMode & o.TextRenderingMode.ADD_TO_PATH_FLAG && t.txtElement && t.txtElement.hasChildNodes() && (t.element = t.txtElement,
                    this.clip("nonzero"),
                    this.endPath())
                }
            }, {
                ...
                value: function shadingFill(t) {
                    ...
                    this.current.fillAlpha < 1 && g.setAttributeNS(null, "fill-opacity", this.current.fillAlpha),
                ...
                value: function _makeTilingPattern(t) {
                    ...
                    return this.executeOpTree(this.convertOpList(a)),
                    this.svg = T,
                ...
                value: function _makeShadingPattern(t) {
                    switch (t[0]) {
                    case "RadialAxial":
                        var r, a = "shading".concat(_++), i = t[3];
                        switch (t[1]) {
                        case "axial":
                            var l = t[4]
                              , u = t[5];
                            (r = this.svgFactory.createElement("svg:linearGradient")).setAttributeNS(null, "id", a),
                        ...
                        case "radial":
                            var c = t[4]
                              ...
                              , h = t[6]
                              , p = t[7];
                            (r = this.svgFactory.createElement("svg:radialGradient")).setAttributeNS(null, "id", a),
                            r.setAttributeNS(null, "gradientUnits", "userSpaceOnUse"),
                        ...
                        return this.defs.appendChild(r),
                        "url(#".concat(a, ")");
                    case "Mesh":
                        return (0,
                        o.warn)("Unimplemented pattern Mesh"),
                        null;
                    case "Dummy":
                        return "hotpink";
                    default:
                ...
                value: function constructPath(t, r) {
                    var a, i = this.current, l = i.x, u = i.y, d = [], h = 0, p = _createForOfIteratorHelper(t);
                    try {
                        for (p.s(); !(a = p.n()).done; ) {
                            switch (0 | a.value) {
                            case o.OPS.rectangle:
                            ...
                            case o.OPS.curveTo:
                                l = r[h + 4],
                                u = r[h + 5],
                                d.push("C", c(r[h]), c(r[h + 1]), c(r[h + 2]), c(r[h + 3]), c(l), c(u)),
                                h += 6;
                                break;
                            case o.OPS.curveTo2:
                    ...
                    d = d.join(" "),
                    i.path && t.length > 0 && t[0] !== o.OPS.rectangle && t[0] !== o.OPS.moveTo ? d = i.path.getAttributeNS(null, "d") + d : (i.path = this.svgFactory.createElement("svg:path"),
                ...
                value: function endPath() {
                    ...
                    this.pendingClip)
                        if (t.element) {
                            ...
                            "evenodd" === this.pendingClip ? o.setAttributeNS(null, "clip-rule", "evenodd") : o.setAttributeNS(null, "clip-rule", "nonzero"),
                            this.pendingClip = null,
                            a.appendChild(o),
                            this.defs.appendChild(a),
                            t.activeClipUrl && (t.clipGroup = null,
                ...
                value: function setGState(t) {
                    ...
                    try {
                        for (a.s(); !(r = a.n()).done; ) {
                            ...
                            default:
                                (0,
                                o.warn)("Unimplemented graphic state operator ".concat(l))
                            }
                        }
                    } catch (t) {
                        a.e(t)
                ...
                value: function paintImageXObject(t) {
                    ...
                    r ? this.paintInlineImageXObject(r) : (0,
                    o.warn)("Dependent image with object ID ".concat(t, " is not ready yet"))
                }
            }, {
                ...
                value: function paintInlineImageXObject(t, r) {
                    ...
                    u.setAttributeNS(null, "transform", "scale(".concat(c(1 / a), " ").concat(c(-1 / o), ")")),
                ...
                value: function _initialize(t) {
                    ...
                    return o.setAttributeNS(null, "transform", d(t.transform)),
                    r.appendChild(o),
                    this.svg = o,
                    r
                }
        ...
        var m = function() {
            function PDFNodeStream(t) {
                ...
                this.url = function parseUrl(t) {
                    var r = h.parse(t);
                    return "file:" === r.protocol || r.host ? r : /^[a-z]:[/\\]/i.test(t) ? h.parse("file:///".concat(t)) : (r.host || (r.protocol = "file:"),
                    r)
                }(t.url),
            ...
            return _createClass(PDFNodeStream, [{
                ...
                value: function getRangeReader(t, r) {
                    ...
                    return this._rangeRequestReaders.push(a),
                    a
                }
            }, {
                key: "cancelAllRequests",
                    ...
                    return o.default.wrap((function _callee$(a) {
                        for (; ; )
                            ...
                            case 6:
                                ...
                                return this._readCapability = (0,
                                i.createPromiseCapability)(),
                                a.abrupt("return", this.read());
                            case 10:
                                return this._loaded += t.length,
        ...
        var y = function(t) {
            ...
            function PDFNodeStreamFullReader(t) {
                ...
                var o = function handleResponse(r) {
                    if (404 === r.statusCode) {
                        ...
                        return a._storedError = o,
                        void a._headersCapability.reject(o)
                    }
                    a._headersCapability.resolve(),
                    a._setReadableStream(r);
                    ...
                    a._filename = (0,
                    l.extractFilenameFromHeader)(u)
                };
                return (a = r.call(this, t))._request = null,
                "http:" === a._url.protocol ? a._request = c.request(createRequestOptions(a._url, t.httpHeaders), o) : a._request = d.request(createRequestOptions(a._url, t.httpHeaders), o),
                a._request.on("error", (function(t) {
                    a._storedError = t,
                    a._headersCapability.reject(t)
                }
                )),
                a._request.end(),
                a
          ...
          , b = function(t) {
            ...
            function PDFNodeStreamRangeReader(t, a, o) {
                ...
                var p = function handleResponse(t) {
                    if (404 !== t.statusCode)
                        l._setReadableStream(t);
                    else {
                        var r = new i.MissingPDFException('Missing PDF "'.concat(l._url, '".'));
                        l._storedError = r
                    }
                };
                return l._request = null,
                "http:" === l._url.protocol ? l._request = c.request(createRequestOptions(l._url, l._httpHeaders), p) : l._request = d.request(createRequestOptions(l._url, l._httpHeaders), p),
          ...
          , _ = function(t) {
            ...
            function PDFNodeStreamFsFullReader(t) {
                ...
                return p.test(a._url.href) && (o = o.replace(/^\//, "")),
                u.lstat(o, (function(t, r) {
                    if (t)
                        return "ENOENT" === t.code && (t = new i.MissingPDFException('Missing PDF "'.concat(o, '".'))),
                        a._storedError = t,
          ...
          , S = function(t) {
            ...
            function PDFNodeStreamFsRangeReader(t, a, o) {
                ...
                return p.test(i._url.href) && (l = l.replace(/^\//, "")),
                i._setReadableStream(u.createReadStream(l, {
                    start: a,
                    end: o - 1
                })),
                i
    ...
    , function(t, r, a) {
        ...
        r.extractFilenameFromHeader = function extractFilenameFromHeader(t) {
            ...
            if (r) {
                var a = (0,
                i.getFilenameFromContentDispositionHeader)(r);
                if (a.includes("%"))
                    try {
        ...
        r.validateRangeRequestCapabilities = function validateRangeRequestCapabilities(t) {
            var r = t.getResponseHeader
              ...
              , l = t.disableRange;
            (0,
            o.assert)(i > 0, "Range chunk size must be larger than zero");
            var u = {
            ...
            if (!Number.isInteger(c))
                return u;
            if (u.suggestedLength = c,
            c <= 2 * i)
                return u;
            if (l || !a)
                return u;
            if ("bytes" !== r("Accept-Ranges"))
                return u;
            if ("identity" !== (r("Content-Encoding") || "identity"))
                return u;
            return u.allowRangeRequests = !0,
            u
        }
        ,
    ...
    , function(t, r, a) {
        ...
        r.getFilenameFromContentDispositionHeader = function getFilenameFromContentDispositionHeader(t) {
            ...
            if (a = function rfc2231getparam(t) {
                var r, a = [], o = toParamRegExp("filename\\*((?!0\\d)\\d+)(\\*?)", "ig");
                for (; null !== (r = o.exec(t)); ) {
            ...
            function fixupEncoding(t) {
                return r && /[\x80-\xff]/.test(t) && (t = textdecode("utf-8", t),
                r && (t = textdecode("iso-8859-1", t))),
                t
            }
            ...
            function rfc2047decode(t) {
                return !t.startsWith("=?") || /[\x00-\x19\x80-\xff]/.test(t) ? t : t.replace(/=\?([\w-]*)\?([QqBb])\?((?:[^?]|\?(?!=))*)\?=/g, (function(t, r, a, o) {
                    if ("q" === a || "Q" === a)
                        return textdecode(r, o = (o = o.replace(/_/g, " ")).replace(/=([0-9a-fA-F]{2})/g, (function(t, r) {
    ...
    , function(t, r, a) {
        ...
        var u = function() {
            function NetworkManager(t, r) {
                ...
                this.getXhr = r.getXhr || function NetworkManager_getXhr() {
            ...
            return _createClass(NetworkManager, [{
                ...
                value: function request(t) {
                    ...
                    return this.isHttp && "begin"in t && "end"in t ? (r.setRequestHeader("Range", "bytes=".concat(t.begin, "-").concat(t.end - 1)),
                    o.expectedStatus = 206) : o.expectedStatus = 200,
                    r.responseType = "arraybuffer",
                    t.onError && (r.onerror = function(a) {
                        t.onError(r.status)
                    }
                    ),
                ...
                value: function onStateChange(t, r) {
                    ...
                    if (a) {
                        var o = a.xhr;
                        if (o.readyState >= 2 && a.onHeadersReceived && (a.onHeadersReceived(),
                            ...
                            0 === o.status && this.isHttp)
                                ...
                                if (200 === l && 206 === a.expectedStatus || l === a.expectedStatus) {
                                    var u = function getArrayBuffer(t) {
                                        var r = t.response;
                                        return "string" != typeof r ? r : (0,
                                        i.stringToBytes)(r).buffer
                                    }(o);
                                    if (206 === l) {
          ...
          , c = function() {
            ...
            return _createClass(PDFNetworkStream, [{
                ...
                value: function getRangeReader(t, r) {
                    ...
                    return a.onClosed = this._onRangeRequestReaderClosed.bind(this),
        ...
        var d = function() {
            ...
            return _createClass(PDFNetworkStreamFullRequestReader, [{
                ...
                value: function _onDone(t) {
                    ...
                    this._done = !0,
                    this._cachedChunks.length > 0 || (this._requests.forEach((function(t) {
                        t.resolve({
                            value: void 0,
                            done: !0
                        })
                ...
                value: function _onError(t) {
                    var r = this._url
                      , a = (0,
                    l.createResponseStatusError)(t, r);
                    this._storedError = a,
                    ...
                    return o.default.wrap((function _callee$(a) {
                        for (; ; )
                            ...
                            case 2:
                                ...
                                return t = this._cachedChunks.shift(),
                                a.abrupt("return", {
                                    value: t,
                                    done: !1
                                });
        ...
        var c = function() {
            function PDFFetchStreamReader(t) {
                ...
                fetch(o, createFetchOptions(this._headers, this._withCredentials, this._abortController)).then((function(t) {
                    if (!(0,
                    l.validateResponseStatus)(t.status))
                        throw (0,
                        l.createResponseStatusError)(t.status, o);
                    r._reader = t.body.getReader(),
                    ...
                    r._filename = (0,
                    l.extractFilenameFromHeader)(a),
                    !r._isStreamingSupported && r._isRangeSupported && r.cancel(new i.AbortException("Streaming is disabled."))
                }
                ...
                value: (t = _asyncToGenerator(o.default.mark((function _callee() {
                    ...
                    return o.default.wrap((function _callee$(o) {
                        for (; ; )
                            ...
                            case 9:
                                return this._loaded += r.byteLength,
                                this.onProgress && this.onProgress({
                                    loaded: this._loaded,
                                    total: this._contentLength
                                }),
          ...
          , d = function() {
            function PDFFetchStreamRangeReader(t, r, a) {
                ...
                fetch(c, createFetchOptions(this._headers, this._withCredentials, this._abortController)).then((function(t) {
                    ...
                    l.validateResponseStatus)(t.status))
                        throw (0,
                        l.createResponseStatusError)(t.status, c);
                    o._readCapability.resolve(),
                    o._reader = t.body.getReader()
                }
                )),
                this.onProgress = null
            }
