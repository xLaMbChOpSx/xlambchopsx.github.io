    ...
    var _GraphUtils = __webpack_require__(4)
      ...
      , ImageBase = function() {
        ...
        ImageBase.prototype.setRenderPause = function(renderPause) {
            ...
            !renderPause && this.continueRender && (this.continueRender(),
            delete this.continueRender)
        }
        ,
        ImageBase.prototype.cancelRender = function() {
            this.renderTask && this.renderTask.cancel && (this.renderTask.cancel(),
        ...
        ImageBase.prototype.pushCtx = function() {
            return Math.abs(this.resW - this.c.width) >= 1 && (this.c.width = Math.ceil(this.resW)),
    ...
    : function(obj) {
      ...
      , SheetBlock = function() {
        ...
        SheetBlock.prototype.set = function(angle) {
            ...
            if ("closed" === this.state)
                ...
                if (void 0 !== closedAngle && Math.abs(closedAngle - PI / 2) > .01) {
                    ...
                    points = this.getInterpolationPoints(this.openedInterpolationIndeces["right" === flipDirection ? this.angle > PI / 2 ? "left" : "right" : this.angle < PI / 2 ? "left" : "right"], this.closedInterpolationIndeces);
            var hl = void 0
              , hr = void 0
        ...
        SheetBlock.prototype.getPointsAtHs = function(ps, angle, hs) {
            ...
            sp.set(sp.x + .2 * dp.x / ln, sp.y + .2 * dp.y / ln, 0),
        ...
        SheetBlock.prototype.loadPoints = function() {
            ...
            return {
                interpolationPoints: [{
                    x: [[0, .25, .5, .75, 1], [0, .2482, .4997, .75, 1], [0, .2428, .4989, .75, 1], [0, .125, .3214, .566, .8192], [0, 0, 0, 0, 0], x],
                    y: [[0, 0, 0, 0, 0], [0, .03, .0166, .0033, 1e-4], [0, .0596, .0331, .0065, 2e-4], [0, .2165, .383, .492, .5736], [0, .25, .5, .75, 1], y]
                }, {
                    x: [[0, .25, .5, .75, 1], [0, .2482, .4997, .75, 1], [0, .2428, .4989, .75, 1], [0, .125, .3214, .5574, .8192], [0, -.0434, 0, .1302, .342], [0, .0434, -0, -.1302, -.342], [0, .1705, .341, .4821, .5736], [0, 0, 0, 0, 0], x],
                    y: [[0, 0, 0, 0, 0], [0, .03, .0166, .0033, 1e-4], [0, .0596, .0331, .0065, 2e-4], [0, .2165, .383, .5018, .5736], [0, .2462, .5, .7386, .9397], [0, .2462, .5, .7386, .9397], [0, .1828, .3657, .5745, .8192], [0, .25, .5, .75, 1], y]
                }, {
    ...
    _libs.$.fn.FlipBook = function(options) {
        ...
        scene.view = new _BookView2.default(parentContainer,function() {
            if (_Detector2.default.webgl) {
                ...
                options.propertiesCallback && new _ClbBookPropsBuilder2.default(scene.visual,function() {
                    return {
                        type: "blank"
                    }
                }
                ,1,function(props) {
                    ...
                    var style = [];
                    "" !== props.backgroundColor && style.push("background-color:#" + new THREE.Color(props.backgroundColor).getHexString()),
                    "" !== props.backgroundImage && style.push("background-image:url('" + props.backgroundImage + "')"),
                    "" !== props.backgroundStyle && style.push(props.backgroundStyle),
                    style.length && scene.view.getView().attr("style", style.join(";"))
                }
                ),
                scene.bookBuilder = function(props, sheets, pageCallback) {
                    ...
                    options.outline && (scene.bookmarks = new _Bookmarks2.default(scene.view.getBookmarksView(),options.outline),
                    scene.tocCtrl.setBookmarks(scene.bookmarks)),
                    scene.ctrl.setTocCtrl(scene.tocCtrl),
                    scene.view.addHandler(scene.tocCtrl),
                    "pdf" === test.type && (scene.search = new _Search2.default(scene.view.getSearchView(),scene.book.getPages()),
                    ...
                    scene.bookmarks || test.src.getHandler(function(handler) {
                        handler.getOutline().then(function(outline) {
                            outline && outline.length && (scene.bookmarks = new _Bookmarks2.default(scene.view.getBookmarksView(),outline),
                ...
                options.pdf ? (scene.propsBuilder = new _PdfBookPropsBuilder2.default(options.pdf,scene.bookBuilder,options.bookStyle,options.pdfOpenOptions),
    ...
    var _extends = Object.assign || function(target) {
      ...
      , Binder = function() {
        function Binder(visual, p) {
            ...
            this.backG = new _libs.THREE.BoxGeometry(.001,this.p.backSize,p.cover.height);
            var color = {
                color: p.cover.color
            }
              , transparent = {
            ...
            hidden || (backM.position.set(.5 * (p.cover.depth - .001), 0, 0),
            this.back.add(backM)),
    ...
    var _extends = Object.assign || function(target) {
      ...
      , Book = function(_THREE$EventDispatche) {
        function Book(visual, sheets, pageCallback, props) {
            ...
            _this.p = _extends({}, _this.prepareProps(_extends({}, props, {
                sheets: sheets
            })), {
        ...
        Book.prototype.calculateShadow = function() {
            ...
            this.bookShadow.position.set(.5 * (box.max.x + box.min.x) - .015, box.min.y - .0015, .5 * (box.max.z + box.min.z) - .015),
            this.bookShadowMaterial.opacity = .03,
            this.visual.shadowPlace.position.set(0, box.min.y - .015, 0)
        }
        ,
        ...
        Book.prototype.connectPhysics = function(block, mass, angle, velocity, flexibility, coverHeight, simulateClb, removeClb, progressClb) {
            ...
            return block !== this.leftCover && block !== this.rightCover || (this.bookShadowMaterial.opacity = 0),
            res.then(function() {
                return block.physicId = _this7.sheetPhysics.addObject(mass, angle, velocity, flexibility, coverHeight, function(angl, ch) {
                    ...
                    Promise.resolve().then(function() {
                        _this7.sheetPhysics.getSize() || (_this7.notifyAfterAnimation(),
                        _this7.calculateShadow())
                    }),
                    _this7.updateThree()
                ...
                1 === _this7.sheetPhysics.getSize() && _this7.reducePagesWidth(!1),
                block
            }).catch(function() {})
        }
        ,
        Book.prototype.update = function(dt) {
            ...
            Promise.resolve().then(function() {
                (0,
                _libs.$)(_this8.visual.element).trigger(_libs.$.Event("mousemove", _this8.lastMousePos))
            })),
        ...
        Book.prototype.cssLayerJsObjectInit = function(c, p) {
            ...
            return {
                hide: function() {
                    _this11.pendingPlayers.length && (_this11.pendingPlayers = [],
      ...
      , BookController = function(_Controller) {
        ...
        BookController.prototype.loadingAnimationHandler = function() {
            for (var _this3 = this, pages = this.book.getTopPages(), visible = !1, _iterator = pages, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator](); ; ) {
                ...
                if (visible = "active" !== state)
                    break
            }
            visible = visible || this.printer && this.printer.loading,
            visible ? this.pendingLoadingAnimation || (this.pendingLoadingAnimation = !0,
            setTimeout(function() {
                _this3.pendingLoadingAnimation && _this3.view && _this3.view.setState("widLoading", {
                    visible: visible
                })
            }, 2e3)) : (delete this.pendingLoadingAnimation,
            ...
            setTimeout(function() {
                if (_this4.pendingAutoPlay === pendingAutoPlay && _this4.state.autoPlay) {
                    if (!_this4.book.isProcessing()) {
                        var flipped = void 0;
                        _this4.p.rtl ? (flipped = _this4.canFlipLeft()) && _this4.cmdBackward() : (flipped = _this4.canFlipRight()) && _this4.cmdForward(),
        ...
        BookController.prototype.goToPage = function(page) {
            ...
            var setClb = function(fl, time, clb) {
                return new Promise(function(resolve) {
                    setTimeout(function() {
                        fl < 0 ? _this7.startFlip(_this7.book.flipLeft(-fl, clb)) : _this7.startFlip(_this7.book.flipRight(fl, clb)),
                        resolve()
                    }, time)
                }
                )
            ...
            return _extends({}, cmds, {
                ...
                mouseCmdWheelZoom: {
                    activate: function(e) {
                        ...
                        e.deltaY < 0 ? _this9.cmdZoomOut() : e.deltaY > 0 && _this9.cmdZoomIn(),
                        (!_this9.state.smartPan || Math.abs(_this9.bookWatcher.scale - scale) > 1e-4) && e.preventDefault()
                    }
                },
                touchCmdRotate: {
                    activate: function(e, data) {
                ...
                touchCmdPan: {
                    activate: function(e, data) {
                        isSwipping("touchCmdPan") || "move" === data.state && (!_this9.state.smartPan || _this9.bookWatcher.scale > 1) && (e.preventDefault(),
                    ...
                    activate: function(e, data) {
                        if (isSwipping("touchCmdSwipe"))
                            if ("start" === data.state) {
                                ...
                                "move" === data.state ? _this9.swipeData.handled || (_this9.swipeData = _extends({}, _this9.swipeData, {
                                    x: _this9.swipeData.x + data.dx,
                                    y: _this9.swipeData.y + data.dy
                                }),
                                Math.abs(_this9.swipeData.x0 - _this9.swipeData.x) > 100 && (_this9.swipeData.x0 > _this9.swipeData.x ? _this9.cmdForward() : _this9.cmdBackward(),
                                _this9.swipeData.handled = !0)) : delete _this9.swipeData
                    }
                },
                widSettings: {
                    activate: function() {}
        ...
        BookController.prototype.bindActions = function() {
            ...
            this.eToA.addAction(function(e) {
                return (0,
                _libs.$)(_this10.view.getParentContainer()).trigger(e)
            }, "keydown", 27, 0),
            ...
            for (var _iterator5 = Object.keys(this.actions), _isArray5 = Array.isArray(_iterator5), _i5 = 0, _iterator5 = _isArray5 ? _iterator5 : _iterator5[Symbol.iterator](); ; ) {
                ...
                0 !== name.indexOf("mouseCmd") && 0 !== name.indexOf("touchCmd") || action.enabled) {
    ...
    var _libs = __webpack_require__(1)
      , BookPrinter = function(_THREE$EventDispatche) {
        function BookPrinter(context, book, styleSheet) {
            ...
            return _this.type = test.type,
            "pdf" === _this.type && (_this.pdfSrc = test.src.src),
            _this
        }
        return _inherits(BookPrinter, _THREE$EventDispatche),
        ...
        BookPrinter.prototype.print = function() {
            ...
            if (!this.loading)
                ...
                "pdf" === this.type) {
                    ...
                    _libs.$)('<iframe src="' + this.pdfSrc + '" style="display: none;"></iframe>').appendTo(document.body)),
                    printWnd = this.frame[0].contentWindow) : printWnd = this.wnd.open(this.pdfSrc),
                    callManually ? printWnd.print() : (this.loading = !0,
                    this.dispatchEvent({
                        type: "loading"
                    }),
                    (0,
                    _libs.$)(this.frame).on("load", function() {
                        setTimeout(function() {
        ...
        BookPrinter.prototype.renderContent = function() {
            for (var _this3 = this, pages = this.book.getPages(), head = new Set, body = [], done = Promise.resolve(), page = 0; page < pages; ++page)
                !function(page) {
                    var info = _this3.pageCallback(page);
                    "image" === info.type ? done = done.then(function() {
                        return _this3.progress(page / pages),
      ...
      , PageManager = function() {
            ...
            Promise.resolve().then(function() {
                if (o.texture) {
                    ...
                    o.wrapper.onChange = function(image, canceled) {
                        canceled ? ("queuedForRender" !== o.state && (o.state = "loaded",
                        o.wrapper && _this3.pushInRenderQueue(_this3.rendering)),
                        delete _this3.rendering) : o.texture && (_this3.removeFromLoadings(o),
        ...
        PageManager.prototype.updateRenderQueue = function() {
            if (this.canvases) {
                var p = this.p;
                if (this.rendering)
                    this.rendering.wrapper && this.rendering.wrapper.setRenderPause(!p.renderWhileFlipping && (this.book.isProcessing() || this.visual.getOrbit().isMoving())),
                    this.book.updateThree();
    ...
    var _BookPropsBuilder2 = __webpack_require__(9)
      ...
      , PdfBookPropsBuilder = function(_BookPropsBuilder) {
        function PdfBookPropsBuilder(src, onReady, style, pdfOpenOptions) {
            ...
            var _this = _possibleConstructorReturn(this, _BookPropsBuilder.call(this, onReady, style));
            return _this.pdf = new _Pdf2.default(src,void 0,pdfOpenOptions),
    ...
    var _WidgetController2 = __webpack_require__(22)
      ...
      , TocController = function(_WidgetController) {
        ...
        TocController.prototype.setBookmarks = function(bookmarks, pdf) {
            bookmarks.getSize() && (this.bookmarks = bookmarks,
            this.pdf = pdf,
            ...
            return scope.pan = function() {
                ...
                return function(deltaX, deltaY) {
                    ...
                    if (scope.object instanceof _libs.THREE.PerspectiveCamera) {
                        ...
                        scope.object instanceof _libs.THREE.OrthographicCamera ? (panLeft(deltaX * (scope.object.right - scope.object.left) / scope.object.zoom / clientWidth, scope.object.matrix),
                        panUp(deltaY * (scope.object.top - scope.object.bottom) / scope.object.zoom / clientHeight, scope.object.matrix)) : (console.warn("WARNING: OrbitControls.js encountered an unknown camera type-pan disabled."),
                        scope.enablePan = !1)
                }
            }(),
            _this.actions = {
      ...
      , PdfImage = function(_ImageBase) {
        ...
        PdfImage.prototype.renderHits = function() {
            ...
            if (this.finder) {
                ...
                (0,
                _libs.$)('<div style="position: absolute; visibility: hidden;"></div>').appendTo("body")), textDiv = testSz[0], baseOffset = testSz.offset().left, _iterator4 = this.finder.getHits(), _isArray4 = Array.isArray(_iterator4), _i4 = 0, _iterator4 = _isArray4 ? _iterator4 : _iterator4[Symbol.iterator](); ; ) {
                    var _ref4;
                    if (_isArray4) {
                        if (_i4 >= _iterator4.length)
                            break;
        ...
        PdfImage.prototype.calcViewport = function() {
            ...
            "full" !== this.type && ("right" === this.type ? (this.viewport.offsetX += .5 * this.viewport.width * 1.0005,
            this.viewport.transform[4] -= .5 * this.viewport.width * 1.0005,
            this.viewport.width *= .5 / 1.0005) : this.viewport.width /= 2),
    ...
    var _libs = __webpack_require__(0)
      , Search = function() {
        ...
        Search.prototype.setResults = function(results, lastPage) {
            ...
            void 0 === lastPage ? this.status.html("") : this.status.html(lastPage + 1 + " of " + this.pages)
        }
        ,
        Search
    }();
    ...
    var _extends = Object.assign || function(target) {
      ...
      , View = function() {
            ...
            var build = function build() {
                ...
                _this3.loadFiles(urls, files).then(function() {
                    ...
                    for (var _iterator8 = links, _isArray8 = Array.isArray(_iterator8), _i8 = 0, _iterator8 = _isArray8 ? _iterator8 : _iterator8[Symbol.iterator](); ; ) {
                        ...
                        _libs.$)(["<link ", _this3.objToAttrsStr(_extends({}, _link, {
        ...
        View.prototype.urlResolver = function(baseUrl, url) {
            ...
            "/" === url.charAt(0) && (baseUrl = this.getRootUrl(),
            url = url.substr(1)),
            baseUrl.match(/^https{0,1}:/i) || (baseUrl = this.urlResolver(this.getCurrentUrl(), baseUrl)),
    ...
    var _extends = Object.assign || function(target) {
      ...
      , VisualWorld = function(_THREE$EventDispatche) {
        function VisualWorld(wnd, doc, container) {
            ...
            _this.light.shadow.camera.near = .5,
            ...
            _this.shadowPlace = new _libs.THREE.Mesh(new _libs.THREE.PlaneGeometry(10,10).rotateX(-Math.PI / 2),new _libs.THREE.ShadowMaterial({
                color: 0,
                transparent: !0,
                opacity: .2
            })),
        ...
        VisualWorld.prototype.onWindowResize = function() {
            ...
            if (width > 1 && height > 1) {
                ...
                if (!this.lastResize || Math.abs(this.lastResize.width - width) + Math.abs(this.lastResize.height - height) > 1) {
                    ...
                    setTimeout(function() {
                        resizeStamp === _this2.resizeStamp && (updateCamera(_this2.camera),
